...
**custom_field_data** | **object** | Object with custom field information for this organisation. Contains key/value pairs, with key being the field reference and value the field value. | [optional]
