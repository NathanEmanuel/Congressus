...
/**
 * EventCategoriesApi Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
...
class EventCategoriesApi
{
    ...
    /**
     * Operation v30EventCategoriesGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30EventCategoriesGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\EventCategoryPagination
     */
    public function v30EventCategoriesGet($page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30EventCategoriesGet'][0])
    {
        list($response) = $this->v30EventCategoriesGetWithHttpInfo($page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30EventCategoriesGetWithHttpInfo
     *
     * List Event categories
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\EventCategoryPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30EventCategoriesGetWithHttpInfo($page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30EventCategoriesGet'][0])
    {
        $request = $this->v30EventCategoriesGetRequest($page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\EventCategoryPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30EventCategoriesGetAsync
     *
     * List Event categories
     *
     * @param  int|null $page (optional, default to 1)
     ...
     */
    public function v30EventCategoriesGetAsync($page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30EventCategoriesGet'][0])
    {
        return $this->v30EventCategoriesGetAsyncWithHttpInfo($page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30EventCategoriesGetAsyncWithHttpInfo
     *
     * List Event categories
     *
     * @param  int|null $page (optional, default to 1)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30EventCategoriesGetAsyncWithHttpInfo($page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30EventCategoriesGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\EventCategoryPagination';
        $request = $this->v30EventCategoriesGetRequest($page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30EventCategoriesGet'
     *
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     * @param  string|null $order (optional, default to 'name')
     ...
     */
    public function v30EventCategoriesGetRequest($page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30EventCategoriesGet'][0])
    {

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling EventCategoriesApi.v30EventCategoriesGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling EventCategoriesApi.v30EventCategoriesGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling EventCategoriesApi.v30EventCategoriesGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/event-categories';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
