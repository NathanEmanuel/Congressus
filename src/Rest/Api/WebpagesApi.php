...
class WebpagesApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebpagesGet'] to see the possible values for this operation
     *
     ...
     */
    public function v30WebpagesGet($published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebpagesGet'][0])
    {
        list($response) = $this->v30WebpagesGetWithHttpInfo($published, $website_id, $template_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30WebpagesGetWithHttpInfo
     *
     * List Webpages
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     */
    public function v30WebpagesGetWithHttpInfo($published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebpagesGet'][0])
    {
        $request = $this->v30WebpagesGetRequest($published, $website_id, $template_id, $page, $page_size, $order, $contentType);
     ...
     */
    public function v30WebpagesGetAsync($published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebpagesGet'][0])
    {
        return $this->v30WebpagesGetAsyncWithHttpInfo($published, $website_id, $template_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebpagesGetAsyncWithHttpInfo
     *
     * List Webpages
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebpagesGetAsyncWithHttpInfo($published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebpagesGet'][0])
    {
    ...
    /**
     * Create request for operation 'v30WebpagesGet'
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string[]|null $website_id Filter by Website (optional)
     * @param  string[]|null $template_id Filter by Template (optional)
     ...
     */
    public function v30WebpagesGetRequest($published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebpagesGet'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebpagesApi.v30WebpagesGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebpagesApi.v30WebpagesGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebpagesApi.v30WebpagesGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/webpages';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30WebpagesObjIdGet
     *
     * Retrieve Webpage
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebpagesObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebpageWithContent
     */
    public function v30WebpagesObjIdGet($obj_id, string $contentType = self::contentTypes['v30WebpagesObjIdGet'][0])
    {
        list($response) = $this->v30WebpagesObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30WebpagesObjIdGetWithHttpInfo
     *
     * Retrieve Webpage
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebpageWithContent, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebpagesObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebpagesObjIdGet'][0])
    {
        $request = $this->v30WebpagesObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\WebpageWithContent',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30WebpagesObjIdGetAsync
     *
     * Retrieve Webpage
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebpagesObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30WebpagesObjIdGet'][0])
    {
        return $this->v30WebpagesObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebpagesObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Webpage
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebpagesObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebpagesObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\WebpageWithContent';
        $request = $this->v30WebpagesObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30WebpagesObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebpagesObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebpagesObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30WebpagesObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30WebpagesObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling WebpagesApi.v30WebpagesObjIdGet, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/webpages/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
