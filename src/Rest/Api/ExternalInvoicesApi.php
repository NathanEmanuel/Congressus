...
class ExternalInvoicesApi
{
    ...
    /**
     * Operation v30ExternalInvoicesImportsPost
     *
     * Add a new external invoice import
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ExternalInvoicesImportsPost'] to see the possible values for this operation
     *
     ...
     * @return void
     */
    public function v30ExternalInvoicesImportsPost(string $contentType = self::contentTypes['v30ExternalInvoicesImportsPost'][0])
    {
        $this->v30ExternalInvoicesImportsPostWithHttpInfo($contentType);
    }

    /**
     * Operation v30ExternalInvoicesImportsPostWithHttpInfo
     *
     * Add a new external invoice import
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ExternalInvoicesImportsPost'] to see the possible values for this operation
     ...
     */
    public function v30ExternalInvoicesImportsPostWithHttpInfo(string $contentType = self::contentTypes['v30ExternalInvoicesImportsPost'][0])
    {
        $request = $this->v30ExternalInvoicesImportsPostRequest($contentType);
    ...
    /**
     * Operation v30ExternalInvoicesImportsPostAsync
     *
     * Add a new external invoice import
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ExternalInvoicesImportsPost'] to see the possible values for this operation
     ...
     */
    public function v30ExternalInvoicesImportsPostAsync(string $contentType = self::contentTypes['v30ExternalInvoicesImportsPost'][0])
    {
        return $this->v30ExternalInvoicesImportsPostAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ExternalInvoicesImportsPostAsyncWithHttpInfo
     *
     * Add a new external invoice import
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ExternalInvoicesImportsPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ExternalInvoicesImportsPostAsyncWithHttpInfo(string $contentType = self::contentTypes['v30ExternalInvoicesImportsPost'][0])
    {
        $returnType = '';
        $request = $this->v30ExternalInvoicesImportsPostRequest($contentType);
    ...
    /**
     * Create request for operation 'v30ExternalInvoicesImportsPost'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ExternalInvoicesImportsPost'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function v30ExternalInvoicesImportsPostRequest(string $contentType = self::contentTypes['v30ExternalInvoicesImportsPost'][0])
    {


        $resourcePath = '/v30/external-invoices/imports';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
