...
class WebhooksApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebhookPagination
     */
    public function v30WebhooksGet($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksGet'][0])
    {
        list($response) = $this->v30WebhooksGetWithHttpInfo($page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30WebhooksGetWithHttpInfo
     *
     * List Webhooks
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebhookPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebhooksGetWithHttpInfo($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksGet'][0])
    {
        $request = $this->v30WebhooksGetRequest($page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\WebhookPagination',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function v30WebhooksGetAsync($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksGet'][0])
    {
        return $this->v30WebhooksGetAsyncWithHttpInfo($page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebhooksGetAsyncWithHttpInfo
     *
     * List Webhooks
     *
     * @param  int|null $page (optional, default to 1)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksGetAsyncWithHttpInfo($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\WebhookPagination';
        $request = $this->v30WebhooksGetRequest($page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30WebhooksGet'
     *
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     * @param  string|null $order (optional)
     ...
     */
    public function v30WebhooksGetRequest($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksGet'][0])
    {

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebhooksApi.v30WebhooksGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebhooksApi.v30WebhooksGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebhooksApi.v30WebhooksGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/webhooks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30WebhooksObjIdCallsGet
     *
     * List Webhook calls
     *
     * @param  int $obj_id obj_id (required)
     * @param  string|null $period_filter Filter period on &#x60;requested_at&#x60; (optional)
     * @param  string[]|null $status_code Filter by Status code (optional)
     * @param  int|null $page page (optional, default to 1)
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdCallsGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebhookCallPagination
     */
    public function v30WebhooksObjIdCallsGet($obj_id, $period_filter = null, $status_code = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksObjIdCallsGet'][0])
    {
        list($response) = $this->v30WebhooksObjIdCallsGetWithHttpInfo($obj_id, $period_filter, $status_code, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30WebhooksObjIdCallsGetWithHttpInfo
     *
     * List Webhook calls
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebhookCallPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebhooksObjIdCallsGetWithHttpInfo($obj_id, $period_filter = null, $status_code = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksObjIdCallsGet'][0])
    {
        $request = $this->v30WebhooksObjIdCallsGetRequest($obj_id, $period_filter, $status_code, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\WebhookCallPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30WebhooksObjIdCallsGetAsync
     *
     * List Webhook calls
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdCallsGetAsync($obj_id, $period_filter = null, $status_code = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksObjIdCallsGet'][0])
    {
        return $this->v30WebhooksObjIdCallsGetAsyncWithHttpInfo($obj_id, $period_filter, $status_code, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebhooksObjIdCallsGetAsyncWithHttpInfo
     *
     * List Webhook calls
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdCallsGetAsyncWithHttpInfo($obj_id, $period_filter = null, $status_code = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksObjIdCallsGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\WebhookCallPagination';
        $request = $this->v30WebhooksObjIdCallsGetRequest($obj_id, $period_filter, $status_code, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30WebhooksObjIdCallsGet'
     *
     * @param  int $obj_id (required)
     * @param  string|null $period_filter Filter period on &#x60;requested_at&#x60; (optional)
     * @param  string[]|null $status_code Filter by Status code (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebhooksObjIdCallsGetRequest($obj_id, $period_filter = null, $status_code = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebhooksObjIdCallsGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30WebhooksObjIdCallsGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling WebhooksApi.v30WebhooksObjIdCallsGet, must be bigger than or equal to 0.');
        }
        


        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebhooksApi.v30WebhooksObjIdCallsGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebhooksApi.v30WebhooksObjIdCallsGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebhooksApi.v30WebhooksObjIdCallsGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/webhooks/{obj_id}/calls';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30WebhooksObjIdDelete
     *
     * Delete Webhook
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30WebhooksObjIdDelete($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdDelete'][0])
    {
        $this->v30WebhooksObjIdDeleteWithHttpInfo($obj_id, $contentType);
    }

    /**
     * Operation v30WebhooksObjIdDeleteWithHttpInfo
     *
     * Delete Webhook
     *
     * @param  int $obj_id (required)
     ...
     */
    public function v30WebhooksObjIdDeleteWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdDelete'][0])
    {
        $request = $this->v30WebhooksObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Operation v30WebhooksObjIdDeleteAsync
     *
     * Delete Webhook
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdDeleteAsync($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdDelete'][0])
    {
        return $this->v30WebhooksObjIdDeleteAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebhooksObjIdDeleteAsyncWithHttpInfo
     *
     * Delete Webhook
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdDeleteAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30WebhooksObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30WebhooksObjIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebhooksObjIdDeleteRequest($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30WebhooksObjIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling WebhooksApi.v30WebhooksObjIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/webhooks/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30WebhooksObjIdGet
     *
     * Retrieve Webhook
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Webhook
     */
    public function v30WebhooksObjIdGet($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdGet'][0])
    {
        list($response) = $this->v30WebhooksObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30WebhooksObjIdGetWithHttpInfo
     *
     * Retrieve Webhook
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Webhook, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebhooksObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdGet'][0])
    {
        $request = $this->v30WebhooksObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\Webhook',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30WebhooksObjIdGetAsync
     *
     * Retrieve Webhook
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdGet'][0])
    {
        return $this->v30WebhooksObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebhooksObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Webhook
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Webhook';
        $request = $this->v30WebhooksObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30WebhooksObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebhooksObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30WebhooksObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30WebhooksObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling WebhooksApi.v30WebhooksObjIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30WebhooksObjIdPut
     *
     * Update Webhook
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook webhook (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Webhook
     */
    public function v30WebhooksObjIdPut($obj_id, $webhook = null, string $contentType = self::contentTypes['v30WebhooksObjIdPut'][0])
    {
        list($response) = $this->v30WebhooksObjIdPutWithHttpInfo($obj_id, $webhook, $contentType);
        return $response;
    }

    /**
     * Operation v30WebhooksObjIdPutWithHttpInfo
     *
     * Update Webhook
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Webhook, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebhooksObjIdPutWithHttpInfo($obj_id, $webhook = null, string $contentType = self::contentTypes['v30WebhooksObjIdPut'][0])
    {
        $request = $this->v30WebhooksObjIdPutRequest($obj_id, $webhook, $contentType);
    ...
    /**
     * Operation v30WebhooksObjIdPutAsync
     *
     * Update Webhook
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdPutAsync($obj_id, $webhook = null, string $contentType = self::contentTypes['v30WebhooksObjIdPut'][0])
    {
        return $this->v30WebhooksObjIdPutAsyncWithHttpInfo($obj_id, $webhook, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebhooksObjIdPutAsyncWithHttpInfo
     *
     * Update Webhook
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksObjIdPutAsyncWithHttpInfo($obj_id, $webhook = null, string $contentType = self::contentTypes['v30WebhooksObjIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Webhook';
        $request = $this->v30WebhooksObjIdPutRequest($obj_id, $webhook, $contentType);
    ...
    /**
     * Create request for operation 'v30WebhooksObjIdPut'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksObjIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebhooksObjIdPutRequest($obj_id, $webhook = null, string $contentType = self::contentTypes['v30WebhooksObjIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30WebhooksObjIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling WebhooksApi.v30WebhooksObjIdPut, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30WebhooksPost
     *
     * Create Webhook
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook webhook (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Webhook
     */
    public function v30WebhooksPost($webhook = null, string $contentType = self::contentTypes['v30WebhooksPost'][0])
    {
        list($response) = $this->v30WebhooksPostWithHttpInfo($webhook, $contentType);
        return $response;
    }

    /**
     * Operation v30WebhooksPostWithHttpInfo
     *
     * Create Webhook
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook (optional)
     ...
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Webhook, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebhooksPostWithHttpInfo($webhook = null, string $contentType = self::contentTypes['v30WebhooksPost'][0])
    {
        $request = $this->v30WebhooksPostRequest($webhook, $contentType);
    ...
    /**
     * Operation v30WebhooksPostAsync
     *
     * Create Webhook
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksPostAsync($webhook = null, string $contentType = self::contentTypes['v30WebhooksPost'][0])
    {
        return $this->v30WebhooksPostAsyncWithHttpInfo($webhook, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebhooksPostAsyncWithHttpInfo
     *
     * Create Webhook
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebhooksPostAsyncWithHttpInfo($webhook = null, string $contentType = self::contentTypes['v30WebhooksPost'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Webhook';
        $request = $this->v30WebhooksPostRequest($webhook, $contentType);
    ...
    /**
     * Create request for operation 'v30WebhooksPost'
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Webhook|null $webhook (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebhooksPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebhooksPostRequest($webhook = null, string $contentType = self::contentTypes['v30WebhooksPost'][0])
    {
