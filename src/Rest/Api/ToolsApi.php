...
class ToolsApi
{
    ...
    /**
     * Operation v30IbanValidatorGet
     *
     * Return a JSON file with the status of the IBAN
     *
     * @param  string $iban iban (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30IbanValidatorGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\IBANValidatorResponse
     */
    public function v30IbanValidatorGet($iban, string $contentType = self::contentTypes['v30IbanValidatorGet'][0])
    {
        list($response) = $this->v30IbanValidatorGetWithHttpInfo($iban, $contentType);
        return $response;
    }

    /**
     * Operation v30IbanValidatorGetWithHttpInfo
     *
     * Return a JSON file with the status of the IBAN
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\IBANValidatorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30IbanValidatorGetWithHttpInfo($iban, string $contentType = self::contentTypes['v30IbanValidatorGet'][0])
    {
        $request = $this->v30IbanValidatorGetRequest($iban, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\IBANValidatorResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30IbanValidatorGetAsync
     *
     * Return a JSON file with the status of the IBAN
     *
     * @param  string $iban (required)
     ...
     */
    public function v30IbanValidatorGetAsync($iban, string $contentType = self::contentTypes['v30IbanValidatorGet'][0])
    {
        return $this->v30IbanValidatorGetAsyncWithHttpInfo($iban, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30IbanValidatorGetAsyncWithHttpInfo
     *
     * Return a JSON file with the status of the IBAN
     *
     * @param  string $iban (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30IbanValidatorGetAsyncWithHttpInfo($iban, string $contentType = self::contentTypes['v30IbanValidatorGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\IBANValidatorResponse';
        $request = $this->v30IbanValidatorGetRequest($iban, $contentType);
    ...
    /**
     * Create request for operation 'v30IbanValidatorGet'
     *
     * @param  string $iban (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30IbanValidatorGet'] to see the possible values for this operation
     *
     ...
     */
    public function v30IbanValidatorGetRequest($iban, string $contentType = self::contentTypes['v30IbanValidatorGet'][0])
    {

        // verify the required parameter 'iban' is set
        if ($iban === null || (is_array($iban) && count($iban) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $iban when calling v30IbanValidatorGet'
            );
        }
        if (strlen($iban) > 34) {
            throw new \InvalidArgumentException('invalid length for "$iban" when calling ToolsApi.v30IbanValidatorGet, must be smaller than or equal to 34.');
        }
        if (strlen($iban) < 1) {
            throw new \InvalidArgumentException('invalid length for "$iban" when calling ToolsApi.v30IbanValidatorGet, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/v30/iban-validator';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
