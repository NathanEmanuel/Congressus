...
class NotificationsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30NotificationsGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\NotificationPagination
     */
    public function v30NotificationsGet($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30NotificationsGet'][0])
    {
        list($response) = $this->v30NotificationsGetWithHttpInfo($page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30NotificationsGetWithHttpInfo
     *
     * List Notifications
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\NotificationPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30NotificationsGetWithHttpInfo($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30NotificationsGet'][0])
    {
        $request = $this->v30NotificationsGetRequest($page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\NotificationPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30NotificationsGetAsync
     *
     * List Notifications
     *
     * @param  int|null $page (optional, default to 1)
     ...
     */
    public function v30NotificationsGetAsync($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30NotificationsGet'][0])
    {
        return $this->v30NotificationsGetAsyncWithHttpInfo($page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30NotificationsGetAsyncWithHttpInfo
     *
     * List Notifications
     *
     * @param  int|null $page (optional, default to 1)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30NotificationsGetAsyncWithHttpInfo($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30NotificationsGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\NotificationPagination';
        $request = $this->v30NotificationsGetRequest($page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30NotificationsGet'
     *
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     * @param  string|null $order (optional)
     ...
     */
    public function v30NotificationsGetRequest($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30NotificationsGet'][0])
    {

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling NotificationsApi.v30NotificationsGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling NotificationsApi.v30NotificationsGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling NotificationsApi.v30NotificationsGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/notifications';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
