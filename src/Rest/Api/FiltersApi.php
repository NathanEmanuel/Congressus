...
class FiltersApi
{
    ...
    /**
     * Operation v30FiltersGet
     *
     * List Filters
     *
     * @param  string|null $type Filter on &#x60;type&#x60; (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30FiltersGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\FilterPagination
     */
    public function v30FiltersGet($type = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30FiltersGet'][0])
    {
        list($response) = $this->v30FiltersGetWithHttpInfo($type, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30FiltersGetWithHttpInfo
     *
     * List Filters
     *
     * @param  string|null $type Filter on &#x60;type&#x60; (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\FilterPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30FiltersGetWithHttpInfo($type = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30FiltersGet'][0])
    {
        $request = $this->v30FiltersGetRequest($type, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\FilterPagination',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function v30FiltersGetAsync($type = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30FiltersGet'][0])
    {
        return $this->v30FiltersGetAsyncWithHttpInfo($type, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30FiltersGetAsyncWithHttpInfo
     *
     * List Filters
     *
     * @param  string|null $type Filter on &#x60;type&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30FiltersGetAsyncWithHttpInfo($type = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30FiltersGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\FilterPagination';
        $request = $this->v30FiltersGetRequest($type, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30FiltersGet'
     *
     * @param  string|null $type Filter on &#x60;type&#x60; (optional)
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     ...
     */
    public function v30FiltersGetRequest($type = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30FiltersGet'][0])
    {


        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling FiltersApi.v30FiltersGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling FiltersApi.v30FiltersGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling FiltersApi.v30FiltersGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/filters';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30FiltersObjIdGet
     *
     * Retrieve Filter
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30FiltersObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Filter
     */
    public function v30FiltersObjIdGet($obj_id, string $contentType = self::contentTypes['v30FiltersObjIdGet'][0])
    {
        list($response) = $this->v30FiltersObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30FiltersObjIdGetWithHttpInfo
     *
     * Retrieve Filter
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Filter, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30FiltersObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30FiltersObjIdGet'][0])
    {
        $request = $this->v30FiltersObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\Filter',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30FiltersObjIdGetAsync
     *
     * Retrieve Filter
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30FiltersObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30FiltersObjIdGet'][0])
    {
        return $this->v30FiltersObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30FiltersObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Filter
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30FiltersObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30FiltersObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Filter';
        $request = $this->v30FiltersObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30FiltersObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30FiltersObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30FiltersObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30FiltersObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30FiltersObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling FiltersApi.v30FiltersObjIdGet, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/filters/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
