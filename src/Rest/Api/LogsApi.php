...
class LogsApi
{
    ...
    /**
     * Operation v30TasksGet
     *
     * List Tasks
     *
     * @param  int[]|null $author_id Filter by None (optional)
     * @param  int[]|null $assignee_id Filter by None (optional)
     * @param  string[]|null $subject_type Filter by None (optional)
     * @param  string|null $is_completed Filter on &#x60;is_completed&#x60; (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30TasksGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\TaskPagination
     */
    public function v30TasksGet($author_id = null, $assignee_id = null, $subject_type = null, $is_completed = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30TasksGet'][0])
    {
        list($response) = $this->v30TasksGetWithHttpInfo($author_id, $assignee_id, $subject_type, $is_completed, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30TasksGetWithHttpInfo
     *
     * List Tasks
     *
     * @param  int[]|null $author_id Filter by None (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\TaskPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30TasksGetWithHttpInfo($author_id = null, $assignee_id = null, $subject_type = null, $is_completed = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30TasksGet'][0])
    {
        $request = $this->v30TasksGetRequest($author_id, $assignee_id, $subject_type, $is_completed, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\TaskPagination',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function v30TasksGetAsync($author_id = null, $assignee_id = null, $subject_type = null, $is_completed = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30TasksGet'][0])
    {
        return $this->v30TasksGetAsyncWithHttpInfo($author_id, $assignee_id, $subject_type, $is_completed, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30TasksGetAsyncWithHttpInfo
     *
     * List Tasks
     *
     * @param  int[]|null $author_id Filter by None (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30TasksGetAsyncWithHttpInfo($author_id = null, $assignee_id = null, $subject_type = null, $is_completed = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30TasksGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\TaskPagination';
        $request = $this->v30TasksGetRequest($author_id, $assignee_id, $subject_type, $is_completed, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30TasksGet'
     *
     * @param  int[]|null $author_id Filter by None (optional)
     * @param  int[]|null $assignee_id Filter by None (optional)
     * @param  string[]|null $subject_type Filter by None (optional)
     ...
     */
    public function v30TasksGetRequest($author_id = null, $assignee_id = null, $subject_type = null, $is_completed = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30TasksGet'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling LogsApi.v30TasksGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LogsApi.v30TasksGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LogsApi.v30TasksGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/tasks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30TasksObjIdPut
     *
     * Update Task
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\UpdateTask|null $update_task update_task (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30TasksObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Task
     */
    public function v30TasksObjIdPut($obj_id, $update_task = null, string $contentType = self::contentTypes['v30TasksObjIdPut'][0])
    {
        list($response) = $this->v30TasksObjIdPutWithHttpInfo($obj_id, $update_task, $contentType);
        return $response;
    }

    /**
     * Operation v30TasksObjIdPutWithHttpInfo
     *
     * Update Task
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\UpdateTask|null $update_task (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30TasksObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Task, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30TasksObjIdPutWithHttpInfo($obj_id, $update_task = null, string $contentType = self::contentTypes['v30TasksObjIdPut'][0])
    {
        $request = $this->v30TasksObjIdPutRequest($obj_id, $update_task, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 202:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\Task',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30TasksObjIdPutAsync
     *
     * Update Task
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30TasksObjIdPutAsync($obj_id, $update_task = null, string $contentType = self::contentTypes['v30TasksObjIdPut'][0])
    {
        return $this->v30TasksObjIdPutAsyncWithHttpInfo($obj_id, $update_task, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30TasksObjIdPutAsyncWithHttpInfo
     *
     * Update Task
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30TasksObjIdPutAsyncWithHttpInfo($obj_id, $update_task = null, string $contentType = self::contentTypes['v30TasksObjIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Task';
        $request = $this->v30TasksObjIdPutRequest($obj_id, $update_task, $contentType);
    ...
    /**
     * Create request for operation 'v30TasksObjIdPut'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\UpdateTask|null $update_task (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30TasksObjIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30TasksObjIdPutRequest($obj_id, $update_task = null, string $contentType = self::contentTypes['v30TasksObjIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30TasksObjIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling LogsApi.v30TasksObjIdPut, must be bigger than or equal to 0.');
        }
        


        $resourcePath = '/v30/tasks/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($update_task)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_task));
            } else {
                $httpBody = $update_task;
            }
