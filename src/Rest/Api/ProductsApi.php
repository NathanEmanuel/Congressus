...
class ProductsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductPagination
     */
    public function v30ProductsGet($published = null, $status = null, $folder_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30ProductsGet'][0])
    {
        list($response) = $this->v30ProductsGetWithHttpInfo($published, $status, $folder_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsGetWithHttpInfo
     *
     * List Products
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductsGetWithHttpInfo($published = null, $status = null, $folder_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30ProductsGet'][0])
    {
        $request = $this->v30ProductsGetRequest($published, $status, $folder_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\ProductPagination',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function v30ProductsGetAsync($published = null, $status = null, $folder_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30ProductsGet'][0])
    {
        return $this->v30ProductsGetAsyncWithHttpInfo($published, $status, $folder_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsGetAsyncWithHttpInfo
     *
     * List Products
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsGetAsyncWithHttpInfo($published = null, $status = null, $folder_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30ProductsGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\ProductPagination';
        $request = $this->v30ProductsGetRequest($published, $status, $folder_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsGet'
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string|null $status Filter on &#x60;status&#x60; (optional)
     * @param  string[]|null $folder_id Filter by Folder (optional)
     ...
     */
    public function v30ProductsGetRequest($published = null, $status = null, $folder_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30ProductsGet'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ProductsApi.v30ProductsGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductsApi.v30ProductsGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductsApi.v30ProductsGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30ProductsObjIdDelete
     *
     * Delete Product
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30ProductsObjIdDelete($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdDelete'][0])
    {
        $this->v30ProductsObjIdDeleteWithHttpInfo($obj_id, $contentType);
    }

    /**
     * Operation v30ProductsObjIdDeleteWithHttpInfo
     *
     * Delete Product
     *
     ...
     */
    public function v30ProductsObjIdDeleteWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdDelete'][0])
    {
        $request = $this->v30ProductsObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Operation v30ProductsObjIdDeleteAsync
     *
     * Delete Product
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdDeleteAsync($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdDelete'][0])
    {
        return $this->v30ProductsObjIdDeleteAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdDeleteAsyncWithHttpInfo
     *
     * Delete Product
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdDeleteAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30ProductsObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsObjIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdDeleteRequest($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/products/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30ProductsObjIdGet
     *
     * Retrieve Product
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Product
     */
    public function v30ProductsObjIdGet($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdGet'][0])
    {
        list($response) = $this->v30ProductsObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsObjIdGetWithHttpInfo
     *
     * Retrieve Product
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductsObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdGet'][0])
    {
        $request = $this->v30ProductsObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\Product',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30ProductsObjIdGetAsync
     *
     * Retrieve Product
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdGet'][0])
    {
        return $this->v30ProductsObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Product
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Product';
        $request = $this->v30ProductsObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30ProductsObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30ProductsObjIdLogsGet
     *
     * List LogEntries
     *
     * @param  int $obj_id obj_id (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function v30ProductsObjIdLogsGet($obj_id, $author_id = null, $type = null, $page = 1, $page_size = 25, $order = 'created:desc', string $contentType = self::contentTypes['v30ProductsObjIdLogsGet'][0])
    {
        list($response) = $this->v30ProductsObjIdLogsGetWithHttpInfo($obj_id, $author_id, $type, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsObjIdLogsGetWithHttpInfo
     *
     * List LogEntries
     *
     * @param  int $obj_id (required)
     ...
     */
    public function v30ProductsObjIdLogsGetWithHttpInfo($obj_id, $author_id = null, $type = null, $page = 1, $page_size = 25, $order = 'created:desc', string $contentType = self::contentTypes['v30ProductsObjIdLogsGet'][0])
    {
        $request = $this->v30ProductsObjIdLogsGetRequest($obj_id, $author_id, $type, $page, $page_size, $order, $contentType);
    ...
    /**
     * Operation v30ProductsObjIdLogsGetAsync
     *
     * List LogEntries
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsGetAsync($obj_id, $author_id = null, $type = null, $page = 1, $page_size = 25, $order = 'created:desc', string $contentType = self::contentTypes['v30ProductsObjIdLogsGet'][0])
    {
        return $this->v30ProductsObjIdLogsGetAsyncWithHttpInfo($obj_id, $author_id, $type, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdLogsGetAsyncWithHttpInfo
     *
     * List LogEntries
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsGetAsyncWithHttpInfo($obj_id, $author_id = null, $type = null, $page = 1, $page_size = 25, $order = 'created:desc', string $contentType = self::contentTypes['v30ProductsObjIdLogsGet'][0])
    {
    ...
    /**
     * Create request for operation 'v30ProductsObjIdLogsGet'
     *
     * @param  int $obj_id (required)
     * @param  int[]|null $author_id Filter by None (optional)
     * @param  string[]|null $type Filter by None (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdLogsGetRequest($obj_id, $author_id = null, $type = null, $page = 1, $page_size = 25, $order = 'created:desc', string $contentType = self::contentTypes['v30ProductsObjIdLogsGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdLogsGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdLogsGet, must be bigger than or equal to 0.');
        }
        


        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ProductsApi.v30ProductsObjIdLogsGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductsApi.v30ProductsObjIdLogsGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductsApi.v30ProductsObjIdLogsGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/products/{obj_id}/logs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdDelete
     *
     * Delete LogEntry
     *
     * @param  int $obj_id obj_id (required)
     * @param  int $log_entry_id log_entry_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsLogEntryIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30ProductsObjIdLogsLogEntryIdDelete($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdDelete'][0])
    {
        $this->v30ProductsObjIdLogsLogEntryIdDeleteWithHttpInfo($obj_id, $log_entry_id, $contentType);
    }

    /**
     * Operation v30ProductsObjIdLogsLogEntryIdDeleteWithHttpInfo
     *
     * Delete LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductsObjIdLogsLogEntryIdDeleteWithHttpInfo($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdDelete'][0])
    {
        $request = $this->v30ProductsObjIdLogsLogEntryIdDeleteRequest($obj_id, $log_entry_id, $contentType);
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdDeleteAsync
     *
     * Delete LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsLogEntryIdDeleteAsync($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdDelete'][0])
    {
        return $this->v30ProductsObjIdLogsLogEntryIdDeleteAsyncWithHttpInfo($obj_id, $log_entry_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdDeleteAsyncWithHttpInfo
     *
     * Delete LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsLogEntryIdDeleteAsyncWithHttpInfo($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30ProductsObjIdLogsLogEntryIdDeleteRequest($obj_id, $log_entry_id, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsObjIdLogsLogEntryIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  int $log_entry_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsLogEntryIdDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdLogsLogEntryIdDeleteRequest($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdLogsLogEntryIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdLogsLogEntryIdDelete, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'log_entry_id' is set
        if ($log_entry_id === null || (is_array($log_entry_id) && count($log_entry_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $log_entry_id when calling v30ProductsObjIdLogsLogEntryIdDelete'
            );
        }
        if ($log_entry_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$log_entry_id" when calling ProductsApi.v30ProductsObjIdLogsLogEntryIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/products/{obj_id}/logs/{log_entry_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdGet
     *
     * Retrieve LogEntry
     *
     * @param  int $obj_id obj_id (required)
     * @param  int $log_entry_id log_entry_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsLogEntryIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function v30ProductsObjIdLogsLogEntryIdGet($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdGet'][0])
    {
        list($response) = $this->v30ProductsObjIdLogsLogEntryIdGetWithHttpInfo($obj_id, $log_entry_id, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsObjIdLogsLogEntryIdGetWithHttpInfo
     *
     * Retrieve LogEntry
     *
     * @param  int $obj_id (required)
     ...
     */
    public function v30ProductsObjIdLogsLogEntryIdGetWithHttpInfo($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdGet'][0])
    {
        $request = $this->v30ProductsObjIdLogsLogEntryIdGetRequest($obj_id, $log_entry_id, $contentType);
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdGetAsync
     *
     * Retrieve LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsLogEntryIdGetAsync($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdGet'][0])
    {
        return $this->v30ProductsObjIdLogsLogEntryIdGetAsyncWithHttpInfo($obj_id, $log_entry_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdGetAsyncWithHttpInfo
     *
     * Retrieve LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsLogEntryIdGetAsyncWithHttpInfo($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdGet'][0])
    {
    ...
    /**
     * Create request for operation 'v30ProductsObjIdLogsLogEntryIdGet'
     *
     * @param  int $obj_id (required)
     * @param  int $log_entry_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsLogEntryIdGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdLogsLogEntryIdGetRequest($obj_id, $log_entry_id, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdLogsLogEntryIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdLogsLogEntryIdGet, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'log_entry_id' is set
        if ($log_entry_id === null || (is_array($log_entry_id) && count($log_entry_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $log_entry_id when calling v30ProductsObjIdLogsLogEntryIdGet'
            );
        }
        if ($log_entry_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$log_entry_id" when calling ProductsApi.v30ProductsObjIdLogsLogEntryIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdPut
     *
     * Update LogEntry
     *
     * @param  int $obj_id obj_id (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsLogEntryIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\LogEntry
     */
    public function v30ProductsObjIdLogsLogEntryIdPut($obj_id, $log_entry_id, $update_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdPut'][0])
    {
        list($response) = $this->v30ProductsObjIdLogsLogEntryIdPutWithHttpInfo($obj_id, $log_entry_id, $update_log_entry, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsObjIdLogsLogEntryIdPutWithHttpInfo
     *
     * Update LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\LogEntry, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductsObjIdLogsLogEntryIdPutWithHttpInfo($obj_id, $log_entry_id, $update_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdPut'][0])
    {
        $request = $this->v30ProductsObjIdLogsLogEntryIdPutRequest($obj_id, $log_entry_id, $update_log_entry, $contentType);
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdPutAsync
     *
     * Update LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsLogEntryIdPutAsync($obj_id, $log_entry_id, $update_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdPut'][0])
    {
        return $this->v30ProductsObjIdLogsLogEntryIdPutAsyncWithHttpInfo($obj_id, $log_entry_id, $update_log_entry, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdLogsLogEntryIdPutAsyncWithHttpInfo
     *
     * Update LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsLogEntryIdPutAsyncWithHttpInfo($obj_id, $log_entry_id, $update_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\LogEntry';
        $request = $this->v30ProductsObjIdLogsLogEntryIdPutRequest($obj_id, $log_entry_id, $update_log_entry, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsObjIdLogsLogEntryIdPut'
     *
     * @param  int $obj_id (required)
     * @param  int $log_entry_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\UpdateLogEntry|null $update_log_entry (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdLogsLogEntryIdPutRequest($obj_id, $log_entry_id, $update_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsLogEntryIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdLogsLogEntryIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdLogsLogEntryIdPut, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'log_entry_id' is set
        if ($log_entry_id === null || (is_array($log_entry_id) && count($log_entry_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $log_entry_id when calling v30ProductsObjIdLogsLogEntryIdPut'
            );
        }
        if ($log_entry_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$log_entry_id" when calling ProductsApi.v30ProductsObjIdLogsLogEntryIdPut, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30ProductsObjIdLogsPost
     *
     * Create LogEntry
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\CreateLogEntry|null $create_log_entry create_log_entry (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\LogEntry
     */
    public function v30ProductsObjIdLogsPost($obj_id, $create_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsPost'][0])
    {
        list($response) = $this->v30ProductsObjIdLogsPostWithHttpInfo($obj_id, $create_log_entry, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsObjIdLogsPostWithHttpInfo
     *
     * Create LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\LogEntry, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductsObjIdLogsPostWithHttpInfo($obj_id, $create_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsPost'][0])
    {
        $request = $this->v30ProductsObjIdLogsPostRequest($obj_id, $create_log_entry, $contentType);
    ...
    /**
     * Operation v30ProductsObjIdLogsPostAsync
     *
     * Create LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsPostAsync($obj_id, $create_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsPost'][0])
    {
        return $this->v30ProductsObjIdLogsPostAsyncWithHttpInfo($obj_id, $create_log_entry, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdLogsPostAsyncWithHttpInfo
     *
     * Create LogEntry
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdLogsPostAsyncWithHttpInfo($obj_id, $create_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsPost'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\LogEntry';
        $request = $this->v30ProductsObjIdLogsPostRequest($obj_id, $create_log_entry, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsObjIdLogsPost'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\CreateLogEntry|null $create_log_entry (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdLogsPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdLogsPostRequest($obj_id, $create_log_entry = null, string $contentType = self::contentTypes['v30ProductsObjIdLogsPost'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdLogsPost'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdLogsPost, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30ProductsObjIdPut
     *
     * Update Product
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product product (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Product
     */
    public function v30ProductsObjIdPut($obj_id, $product = null, string $contentType = self::contentTypes['v30ProductsObjIdPut'][0])
    {
        list($response) = $this->v30ProductsObjIdPutWithHttpInfo($obj_id, $product, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsObjIdPutWithHttpInfo
     *
     * Update Product
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductsObjIdPutWithHttpInfo($obj_id, $product = null, string $contentType = self::contentTypes['v30ProductsObjIdPut'][0])
    {
        $request = $this->v30ProductsObjIdPutRequest($obj_id, $product, $contentType);
    ...
    /**
     * Operation v30ProductsObjIdPutAsync
     *
     * Update Product
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdPutAsync($obj_id, $product = null, string $contentType = self::contentTypes['v30ProductsObjIdPut'][0])
    {
        return $this->v30ProductsObjIdPutAsyncWithHttpInfo($obj_id, $product, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsObjIdPutAsyncWithHttpInfo
     *
     * Update Product
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsObjIdPutAsyncWithHttpInfo($obj_id, $product = null, string $contentType = self::contentTypes['v30ProductsObjIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Product';
        $request = $this->v30ProductsObjIdPutRequest($obj_id, $product, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsObjIdPut'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsObjIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsObjIdPutRequest($obj_id, $product = null, string $contentType = self::contentTypes['v30ProductsObjIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductsObjIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductsApi.v30ProductsObjIdPut, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30ProductsPost
     *
     * Create Product
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product product (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Product
     */
    public function v30ProductsPost($product = null, string $contentType = self::contentTypes['v30ProductsPost'][0])
    {
        list($response) = $this->v30ProductsPostWithHttpInfo($product, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductsPostWithHttpInfo
     *
     * Create Product
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product (optional)
     ...
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductsPostWithHttpInfo($product = null, string $contentType = self::contentTypes['v30ProductsPost'][0])
    {
        $request = $this->v30ProductsPostRequest($product, $contentType);
    ...
    /**
     * Operation v30ProductsPostAsync
     *
     * Create Product
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsPostAsync($product = null, string $contentType = self::contentTypes['v30ProductsPost'][0])
    {
        return $this->v30ProductsPostAsyncWithHttpInfo($product, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductsPostAsyncWithHttpInfo
     *
     * Create Product
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductsPostAsyncWithHttpInfo($product = null, string $contentType = self::contentTypes['v30ProductsPost'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Product';
        $request = $this->v30ProductsPostRequest($product, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductsPost'
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\Product|null $product (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductsPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductsPostRequest($product = null, string $contentType = self::contentTypes['v30ProductsPost'][0])
    {
