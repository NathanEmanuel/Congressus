...
class WebsitesApi
{
    ...
    /**
     * Operation v30WebsitesGet
     *
     * List Websites
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string[]|null $template_id Filter by Website template (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebsitesGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebsitePagination
     */
    public function v30WebsitesGet($published = null, $template_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebsitesGet'][0])
    {
        list($response) = $this->v30WebsitesGetWithHttpInfo($published, $template_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30WebsitesGetWithHttpInfo
     *
     * List Websites
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebsitePagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebsitesGetWithHttpInfo($published = null, $template_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebsitesGet'][0])
    {
        $request = $this->v30WebsitesGetRequest($published, $template_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\WebsitePagination',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function v30WebsitesGetAsync($published = null, $template_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebsitesGet'][0])
    {
        return $this->v30WebsitesGetAsyncWithHttpInfo($published, $template_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebsitesGetAsyncWithHttpInfo
     *
     * List Websites
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebsitesGetAsyncWithHttpInfo($published = null, $template_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebsitesGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\WebsitePagination';
        $request = $this->v30WebsitesGetRequest($published, $template_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30WebsitesGet'
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string[]|null $template_id Filter by Website template (optional)
     * @param  int|null $page (optional, default to 1)
     ...
     */
    public function v30WebsitesGetRequest($published = null, $template_id = null, $page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30WebsitesGet'][0])
    {



        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebsitesApi.v30WebsitesGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebsitesApi.v30WebsitesGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebsitesApi.v30WebsitesGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/websites';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30WebsitesObjIdGet
     *
     * Retrieve Website
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebsitesObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Website
     */
    public function v30WebsitesObjIdGet($obj_id, string $contentType = self::contentTypes['v30WebsitesObjIdGet'][0])
    {
        list($response) = $this->v30WebsitesObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30WebsitesObjIdGetWithHttpInfo
     *
     * Retrieve Website
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Website, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebsitesObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebsitesObjIdGet'][0])
    {
        $request = $this->v30WebsitesObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\Website',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30WebsitesObjIdGetAsync
     *
     * Retrieve Website
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebsitesObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30WebsitesObjIdGet'][0])
    {
        return $this->v30WebsitesObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebsitesObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Website
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebsitesObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30WebsitesObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Website';
        $request = $this->v30WebsitesObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30WebsitesObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebsitesObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebsitesObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30WebsitesObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30WebsitesObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling WebsitesApi.v30WebsitesObjIdGet, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/websites/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30WebsitesObjIdWebpagesGet
     *
     * List Webpages
     *
     * @param  int $obj_id obj_id (required)
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string[]|null $website_id Filter by Website (optional)
     * @param  string[]|null $template_id Filter by Template (optional)
     * @param  int|null $page page (optional, default to 1)
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional, default to 'order')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30WebsitesObjIdWebpagesGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebpagePagination
     */
    public function v30WebsitesObjIdWebpagesGet($obj_id, $published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebsitesObjIdWebpagesGet'][0])
    {
        list($response) = $this->v30WebsitesObjIdWebpagesGetWithHttpInfo($obj_id, $published, $website_id, $template_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30WebsitesObjIdWebpagesGetWithHttpInfo
     *
     * List Webpages
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\WebpagePagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30WebsitesObjIdWebpagesGetWithHttpInfo($obj_id, $published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebsitesObjIdWebpagesGet'][0])
    {
        $request = $this->v30WebsitesObjIdWebpagesGetRequest($obj_id, $published, $website_id, $template_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\WebpagePagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30WebsitesObjIdWebpagesGetAsync
     *
     * List Webpages
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebsitesObjIdWebpagesGetAsync($obj_id, $published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebsitesObjIdWebpagesGet'][0])
    {
        return $this->v30WebsitesObjIdWebpagesGetAsyncWithHttpInfo($obj_id, $published, $website_id, $template_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30WebsitesObjIdWebpagesGetAsyncWithHttpInfo
     *
     * List Webpages
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30WebsitesObjIdWebpagesGetAsyncWithHttpInfo($obj_id, $published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebsitesObjIdWebpagesGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\WebpagePagination';
        $request = $this->v30WebsitesObjIdWebpagesGetRequest($obj_id, $published, $website_id, $template_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30WebsitesObjIdWebpagesGet'
     *
     * @param  int $obj_id (required)
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string[]|null $website_id Filter by Website (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30WebsitesObjIdWebpagesGetRequest($obj_id, $published = null, $website_id = null, $template_id = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30WebsitesObjIdWebpagesGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30WebsitesObjIdWebpagesGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling WebsitesApi.v30WebsitesObjIdWebpagesGet, must be bigger than or equal to 0.');
        }
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebsitesApi.v30WebsitesObjIdWebpagesGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebsitesApi.v30WebsitesObjIdWebpagesGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling WebsitesApi.v30WebsitesObjIdWebpagesGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/websites/{obj_id}/webpages';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
