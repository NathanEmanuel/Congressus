...
/**
 * StorageFoldersApi Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
...
class StorageFoldersApi
{
    ...
    /**
     * Operation v30StorageFoldersGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolderPagination
     */
    public function v30StorageFoldersGet($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30StorageFoldersGet'][0])
    {
        list($response) = $this->v30StorageFoldersGetWithHttpInfo($published, $parent_id, $term, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageFoldersGetWithHttpInfo
     *
     * List Storage folders
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolderPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageFoldersGetWithHttpInfo($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30StorageFoldersGet'][0])
    {
        $request = $this->v30StorageFoldersGetRequest($published, $parent_id, $term, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\StorageFolderPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30StorageFoldersGetAsync
     *
     * List Storage folders
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     */
    public function v30StorageFoldersGetAsync($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30StorageFoldersGet'][0])
    {
        return $this->v30StorageFoldersGetAsyncWithHttpInfo($published, $parent_id, $term, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageFoldersGetAsyncWithHttpInfo
     *
     * List Storage folders
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersGetAsyncWithHttpInfo($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30StorageFoldersGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageFolderPagination';
        $request = $this->v30StorageFoldersGetRequest($published, $parent_id, $term, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageFoldersGet'
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string|null $parent_id (optional)
     * @param  string|null $term (optional)
     ...
     */
    public function v30StorageFoldersGetRequest($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30StorageFoldersGet'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling StorageFoldersApi.v30StorageFoldersGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling StorageFoldersApi.v30StorageFoldersGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling StorageFoldersApi.v30StorageFoldersGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/storage-folders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30StorageFoldersObjIdDelete
     *
     * Delete Storage folder
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersObjIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30StorageFoldersObjIdDelete($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdDelete'][0])
    {
        $this->v30StorageFoldersObjIdDeleteWithHttpInfo($obj_id, $contentType);
    }

    /**
     * Operation v30StorageFoldersObjIdDeleteWithHttpInfo
     *
     * Delete Storage folder
     *
     ...
     */
    public function v30StorageFoldersObjIdDeleteWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdDelete'][0])
    {
        $request = $this->v30StorageFoldersObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Operation v30StorageFoldersObjIdDeleteAsync
     *
     * Delete Storage folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersObjIdDeleteAsync($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdDelete'][0])
    {
        return $this->v30StorageFoldersObjIdDeleteAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageFoldersObjIdDeleteAsyncWithHttpInfo
     *
     * Delete Storage folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersObjIdDeleteAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30StorageFoldersObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageFoldersObjIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersObjIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageFoldersObjIdDeleteRequest($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30StorageFoldersObjIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling StorageFoldersApi.v30StorageFoldersObjIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/storage-folders/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30StorageFoldersObjIdGet
     *
     * Retrieve Storage folder
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolder
     */
    public function v30StorageFoldersObjIdGet($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdGet'][0])
    {
        list($response) = $this->v30StorageFoldersObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageFoldersObjIdGetWithHttpInfo
     *
     * Retrieve Storage folder
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageFoldersObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdGet'][0])
    {
        $request = $this->v30StorageFoldersObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\StorageFolder',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30StorageFoldersObjIdGetAsync
     *
     * Retrieve Storage folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdGet'][0])
    {
        return $this->v30StorageFoldersObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageFoldersObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Storage folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageFolder';
        $request = $this->v30StorageFoldersObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageFoldersObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageFoldersObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30StorageFoldersObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30StorageFoldersObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling StorageFoldersApi.v30StorageFoldersObjIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30StorageFoldersObjIdPut
     *
     * Update Storage folder
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder storage_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolder
     */
    public function v30StorageFoldersObjIdPut($obj_id, $storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersObjIdPut'][0])
    {
        list($response) = $this->v30StorageFoldersObjIdPutWithHttpInfo($obj_id, $storage_folder, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageFoldersObjIdPutWithHttpInfo
     *
     * Update Storage folder
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageFoldersObjIdPutWithHttpInfo($obj_id, $storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersObjIdPut'][0])
    {
        $request = $this->v30StorageFoldersObjIdPutRequest($obj_id, $storage_folder, $contentType);
    ...
    /**
     * Operation v30StorageFoldersObjIdPutAsync
     *
     * Update Storage folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersObjIdPutAsync($obj_id, $storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersObjIdPut'][0])
    {
        return $this->v30StorageFoldersObjIdPutAsyncWithHttpInfo($obj_id, $storage_folder, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageFoldersObjIdPutAsyncWithHttpInfo
     *
     * Update Storage folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersObjIdPutAsyncWithHttpInfo($obj_id, $storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersObjIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageFolder';
        $request = $this->v30StorageFoldersObjIdPutRequest($obj_id, $storage_folder, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageFoldersObjIdPut'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersObjIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageFoldersObjIdPutRequest($obj_id, $storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersObjIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30StorageFoldersObjIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling StorageFoldersApi.v30StorageFoldersObjIdPut, must be bigger than or equal to 0.');
        }
        ...
        // for model (json/xml)
        if (isset($storage_folder)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($storage_folder));
            } else {
                $httpBody = $storage_folder;
            }
    ...
    /**
     * Operation v30StorageFoldersPost
     *
     * Create Storage folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder storage_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolder
     */
    public function v30StorageFoldersPost($storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersPost'][0])
    {
        list($response) = $this->v30StorageFoldersPostWithHttpInfo($storage_folder, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageFoldersPostWithHttpInfo
     *
     * Create Storage folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder (optional)
     ...
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageFoldersPostWithHttpInfo($storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersPost'][0])
    {
        $request = $this->v30StorageFoldersPostRequest($storage_folder, $contentType);
    ...
    /**
     * Operation v30StorageFoldersPostAsync
     *
     * Create Storage folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersPostAsync($storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersPost'][0])
    {
        return $this->v30StorageFoldersPostAsyncWithHttpInfo($storage_folder, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageFoldersPostAsyncWithHttpInfo
     *
     * Create Storage folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersPostAsyncWithHttpInfo($storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersPost'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageFolder';
        $request = $this->v30StorageFoldersPostRequest($storage_folder, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageFoldersPost'
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $storage_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageFoldersPostRequest($storage_folder = null, string $contentType = self::contentTypes['v30StorageFoldersPost'][0])
    {
    ...
    /**
     * Operation v30StorageFoldersRecursiveGet
     *
     ...
     * @param  int|null $page page (optional, default to 1)
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional, default to 'breadcrumbs')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersRecursiveGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolderListRecursivePagination
     */
    public function v30StorageFoldersRecursiveGet($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'breadcrumbs', string $contentType = self::contentTypes['v30StorageFoldersRecursiveGet'][0])
    {
        list($response) = $this->v30StorageFoldersRecursiveGetWithHttpInfo($published, $parent_id, $term, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageFoldersRecursiveGetWithHttpInfo
     *
     * List Storage folders - recursive
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     * @param  string|null $order (optional, default to 'breadcrumbs')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageFoldersRecursiveGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageFolderListRecursivePagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageFoldersRecursiveGetWithHttpInfo($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'breadcrumbs', string $contentType = self::contentTypes['v30StorageFoldersRecursiveGet'][0])
    {
        $request = $this->v30StorageFoldersRecursiveGetRequest($published, $parent_id, $term, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\StorageFolderListRecursivePagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30StorageFoldersRecursiveGetAsync
     *
     * List Storage folders - recursive
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersRecursiveGetAsync($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'breadcrumbs', string $contentType = self::contentTypes['v30StorageFoldersRecursiveGet'][0])
    {
        return $this->v30StorageFoldersRecursiveGetAsyncWithHttpInfo($published, $parent_id, $term, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageFoldersRecursiveGetAsyncWithHttpInfo
     *
     * List Storage folders - recursive
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageFoldersRecursiveGetAsyncWithHttpInfo($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'breadcrumbs', string $contentType = self::contentTypes['v30StorageFoldersRecursiveGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageFolderListRecursivePagination';
        $request = $this->v30StorageFoldersRecursiveGetRequest($published, $parent_id, $term, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageFoldersRecursiveGet'
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string|null $parent_id (optional)
     * @param  string|null $term (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageFoldersRecursiveGetRequest($published = null, $parent_id = null, $term = null, $page = 1, $page_size = 25, $order = 'breadcrumbs', string $contentType = self::contentTypes['v30StorageFoldersRecursiveGet'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling StorageFoldersApi.v30StorageFoldersRecursiveGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling StorageFoldersApi.v30StorageFoldersRecursiveGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling StorageFoldersApi.v30StorageFoldersRecursiveGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/storage-folders/recursive';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
