...
/**
 * BankMutationsApi Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
...
class BankMutationsApi
{
    ...
    /**
     * Operation v30BankGet
     *
     * List bank mutations
     *
     * @param  string|null $period_filter Filter period on &#x60;mutation_date&#x60; (optional)
     * @param  string|null $status Filter on &#x60;status&#x60; (optional)
     * @param  string|null $mutation_type Filter on &#x60;mutation_type&#x60; (optional)
     * @param  string[]|null $bank_import_id Filter by Bank import (optional)
     * @param  string[]|null $bank_statement_id Filter by Bank statement (optional)
     * @param  string[]|null $bank_mutation_id Filter by Bank mutation (optional)
     * @param  int|null $page page (optional, default to 1)
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional, default to 'mutation_date:desc,id:desc')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\BankMutationPagination
     */
    public function v30BankGet($period_filter = null, $status = null, $mutation_type = null, $bank_import_id = null, $bank_statement_id = null, $bank_mutation_id = null, $page = 1, $page_size = 25, $order = 'mutation_date:desc,id:desc', string $contentType = self::contentTypes['v30BankGet'][0])
    {
        list($response) = $this->v30BankGetWithHttpInfo($period_filter, $status, $mutation_type, $bank_import_id, $bank_statement_id, $bank_mutation_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30BankGetWithHttpInfo
     *
     * List bank mutations
     *
     * @param  string|null $period_filter Filter period on &#x60;mutation_date&#x60; (optional)
     ...
     * @param  string|null $order (optional, default to 'mutation_date:desc,id:desc')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\BankMutationPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30BankGetWithHttpInfo($period_filter = null, $status = null, $mutation_type = null, $bank_import_id = null, $bank_statement_id = null, $bank_mutation_id = null, $page = 1, $page_size = 25, $order = 'mutation_date:desc,id:desc', string $contentType = self::contentTypes['v30BankGet'][0])
    {
        $request = $this->v30BankGetRequest($period_filter, $status, $mutation_type, $bank_import_id, $bank_statement_id, $bank_mutation_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\BankMutationPagination',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function v30BankGetAsync($period_filter = null, $status = null, $mutation_type = null, $bank_import_id = null, $bank_statement_id = null, $bank_mutation_id = null, $page = 1, $page_size = 25, $order = 'mutation_date:desc,id:desc', string $contentType = self::contentTypes['v30BankGet'][0])
    {
        return $this->v30BankGetAsyncWithHttpInfo($period_filter, $status, $mutation_type, $bank_import_id, $bank_statement_id, $bank_mutation_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30BankGetAsyncWithHttpInfo
     *
     * List bank mutations
     *
     * @param  string|null $period_filter Filter period on &#x60;mutation_date&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankGetAsyncWithHttpInfo($period_filter = null, $status = null, $mutation_type = null, $bank_import_id = null, $bank_statement_id = null, $bank_mutation_id = null, $page = 1, $page_size = 25, $order = 'mutation_date:desc,id:desc', string $contentType = self::contentTypes['v30BankGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\BankMutationPagination';
        $request = $this->v30BankGetRequest($period_filter, $status, $mutation_type, $bank_import_id, $bank_statement_id, $bank_mutation_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30BankGet'
     *
     * @param  string|null $period_filter Filter period on &#x60;mutation_date&#x60; (optional)
     * @param  string|null $status Filter on &#x60;status&#x60; (optional)
     * @param  string|null $mutation_type Filter on &#x60;mutation_type&#x60; (optional)
     ...
     */
    public function v30BankGetRequest($period_filter = null, $status = null, $mutation_type = null, $bank_import_id = null, $bank_statement_id = null, $bank_mutation_id = null, $page = 1, $page_size = 25, $order = 'mutation_date:desc,id:desc', string $contentType = self::contentTypes['v30BankGet'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling BankMutationsApi.v30BankGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling BankMutationsApi.v30BankGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling BankMutationsApi.v30BankGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/bank';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $bank_import_id,
            'bank_import_id', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $bank_statement_id,
            'bank_statement_id', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $bank_mutation_id,
            'bank_mutation_id', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation v30BankObjIdDelete
     *
     * Delete bank mutation
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30BankObjIdDelete($obj_id, string $contentType = self::contentTypes['v30BankObjIdDelete'][0])
    {
        $this->v30BankObjIdDeleteWithHttpInfo($obj_id, $contentType);
    }

    /**
     * Operation v30BankObjIdDeleteWithHttpInfo
     *
     * Delete bank mutation
     *
     ...
     */
    public function v30BankObjIdDeleteWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30BankObjIdDelete'][0])
    {
        $request = $this->v30BankObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Operation v30BankObjIdDeleteAsync
     *
     * Delete bank mutation
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdDeleteAsync($obj_id, string $contentType = self::contentTypes['v30BankObjIdDelete'][0])
    {
        return $this->v30BankObjIdDeleteAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30BankObjIdDeleteAsyncWithHttpInfo
     *
     * Delete bank mutation
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdDeleteAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30BankObjIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30BankObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30BankObjIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30BankObjIdDeleteRequest($obj_id, string $contentType = self::contentTypes['v30BankObjIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30BankObjIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling BankMutationsApi.v30BankObjIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/bank/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30BankObjIdGet
     *
     * Retrieve bank mutation
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\BankMutation
     */
    public function v30BankObjIdGet($obj_id, string $contentType = self::contentTypes['v30BankObjIdGet'][0])
    {
        list($response) = $this->v30BankObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30BankObjIdGetWithHttpInfo
     *
     * Retrieve bank mutation
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\BankMutation, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30BankObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30BankObjIdGet'][0])
    {
        $request = $this->v30BankObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\BankMutation',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30BankObjIdGetAsync
     *
     * Retrieve bank mutation
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30BankObjIdGet'][0])
    {
        return $this->v30BankObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30BankObjIdGetAsyncWithHttpInfo
     *
     * Retrieve bank mutation
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30BankObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\BankMutation';
        $request = $this->v30BankObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30BankObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30BankObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30BankObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30BankObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling BankMutationsApi.v30BankObjIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30BankObjIdMatchPost
     *
     * Match mutation with a sale invoice
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\SaleInvoiceBankMutationMatch|null $sale_invoice_bank_mutation_match sale_invoice_bank_mutation_match (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdMatchPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30BankObjIdMatchPost($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdMatchPost'][0])
    {
        $this->v30BankObjIdMatchPostWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match, $contentType);
    }

    /**
     * Operation v30BankObjIdMatchPostWithHttpInfo
     *
     * Match mutation with a sale invoice
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\SaleInvoiceBankMutationMatch|null $sale_invoice_bank_mutation_match (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdMatchPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30BankObjIdMatchPostWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdMatchPost'][0])
    {
        $request = $this->v30BankObjIdMatchPostRequest($obj_id, $sale_invoice_bank_mutation_match, $contentType);
    ...
    /**
     * Operation v30BankObjIdMatchPostAsync
     *
     * Match mutation with a sale invoice
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdMatchPostAsync($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdMatchPost'][0])
    {
        return $this->v30BankObjIdMatchPostAsyncWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30BankObjIdMatchPostAsyncWithHttpInfo
     *
     * Match mutation with a sale invoice
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdMatchPostAsyncWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdMatchPost'][0])
    {
        $returnType = '';
        $request = $this->v30BankObjIdMatchPostRequest($obj_id, $sale_invoice_bank_mutation_match, $contentType);
    ...
    /**
     * Create request for operation 'v30BankObjIdMatchPost'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\SaleInvoiceBankMutationMatch|null $sale_invoice_bank_mutation_match (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdMatchPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30BankObjIdMatchPostRequest($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdMatchPost'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30BankObjIdMatchPost'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling BankMutationsApi.v30BankObjIdMatchPost, must be bigger than or equal to 0.');
        }
        


        $resourcePath = '/v30/bank/{obj_id}/match';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($sale_invoice_bank_mutation_match)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($sale_invoice_bank_mutation_match));
            } else {
                $httpBody = $sale_invoice_bank_mutation_match;
            }
    ...
    /**
     * Operation v30BankObjIdUnmatchPost
     *
     * Remove match with a sale invoice
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\SaleInvoiceBankMutationMatch|null $sale_invoice_bank_mutation_match sale_invoice_bank_mutation_match (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdUnmatchPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30BankObjIdUnmatchPost($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdUnmatchPost'][0])
    {
        $this->v30BankObjIdUnmatchPostWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match, $contentType);
    }

    /**
     * Operation v30BankObjIdUnmatchPostWithHttpInfo
     *
     * Remove match with a sale invoice
     *
     * @param  int $obj_id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30BankObjIdUnmatchPostWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdUnmatchPost'][0])
    {
        $request = $this->v30BankObjIdUnmatchPostRequest($obj_id, $sale_invoice_bank_mutation_match, $contentType);
    ...
    /**
     * Operation v30BankObjIdUnmatchPostAsync
     *
     * Remove match with a sale invoice
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdUnmatchPostAsync($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdUnmatchPost'][0])
    {
        return $this->v30BankObjIdUnmatchPostAsyncWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30BankObjIdUnmatchPostAsyncWithHttpInfo
     *
     * Remove match with a sale invoice
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30BankObjIdUnmatchPostAsyncWithHttpInfo($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdUnmatchPost'][0])
    {
        $returnType = '';
        $request = $this->v30BankObjIdUnmatchPostRequest($obj_id, $sale_invoice_bank_mutation_match, $contentType);
    ...
    /**
     * Create request for operation 'v30BankObjIdUnmatchPost'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\SaleInvoiceBankMutationMatch|null $sale_invoice_bank_mutation_match (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30BankObjIdUnmatchPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30BankObjIdUnmatchPostRequest($obj_id, $sale_invoice_bank_mutation_match = null, string $contentType = self::contentTypes['v30BankObjIdUnmatchPost'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30BankObjIdUnmatchPost'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling BankMutationsApi.v30BankObjIdUnmatchPost, must be bigger than or equal to 0.');
        }
        


        $resourcePath = '/v30/bank/{obj_id}/unmatch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
