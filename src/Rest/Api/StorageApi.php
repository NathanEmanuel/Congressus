...
class StorageApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObjectPagination
     */
    public function v30StorageGet($folder_id = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30StorageGet'][0])
    {
        list($response) = $this->v30StorageGetWithHttpInfo($folder_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageGetWithHttpInfo
     *
     * List StorageObjects
     *
     * @param  string[]|null $folder_id Filter by Folder (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObjectPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageGetWithHttpInfo($folder_id = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30StorageGet'][0])
    {
        $request = $this->v30StorageGetRequest($folder_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\StorageObjectPagination',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function v30StorageGetAsync($folder_id = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30StorageGet'][0])
    {
        return $this->v30StorageGetAsyncWithHttpInfo($folder_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageGetAsyncWithHttpInfo
     *
     * List StorageObjects
     *
     * @param  string[]|null $folder_id Filter by Folder (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageGetAsyncWithHttpInfo($folder_id = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30StorageGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageObjectPagination';
        $request = $this->v30StorageGetRequest($folder_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageGet'
     *
     * @param  string[]|null $folder_id Filter by Folder (optional)
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     ...
     */
    public function v30StorageGetRequest($folder_id = null, $page = 1, $page_size = 25, $order = 'id', string $contentType = self::contentTypes['v30StorageGet'][0])
    {


        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling StorageApi.v30StorageGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling StorageApi.v30StorageGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling StorageApi.v30StorageGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/storage';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30StorageObjIdDelete
     *
     * Delete StorageObject
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30StorageObjIdDelete($obj_id, string $contentType = self::contentTypes['v30StorageObjIdDelete'][0])
    {
        $this->v30StorageObjIdDeleteWithHttpInfo($obj_id, $contentType);
    }

    /**
     * Operation v30StorageObjIdDeleteWithHttpInfo
     *
     * Delete StorageObject
     *
     ...
     */
    public function v30StorageObjIdDeleteWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageObjIdDelete'][0])
    {
        $request = $this->v30StorageObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Operation v30StorageObjIdDeleteAsync
     *
     * Delete StorageObject
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdDeleteAsync($obj_id, string $contentType = self::contentTypes['v30StorageObjIdDelete'][0])
    {
        return $this->v30StorageObjIdDeleteAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageObjIdDeleteAsyncWithHttpInfo
     *
     * Delete StorageObject
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdDeleteAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageObjIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30StorageObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageObjIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageObjIdDeleteRequest($obj_id, string $contentType = self::contentTypes['v30StorageObjIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30StorageObjIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling StorageApi.v30StorageObjIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/storage/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30StorageObjIdFileContentPut
     *
     * Upload a file to an existing storage object
     *
     * @param  int $obj_id obj_id (required)
     * @param  mixed|null $file The file to upload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdFileContentPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30StorageObjIdFileContentPut($obj_id, $file, string $contentType = self::contentTypes['v30StorageObjIdFileContentPut'][0])
    {
        $this->v30StorageObjIdFileContentPutWithHttpInfo($obj_id, $file, $contentType);
    }

    /**
     * Operation v30StorageObjIdFileContentPutWithHttpInfo
     *
     * Upload a file to an existing storage object
     *
     * @param  int $obj_id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageObjIdFileContentPutWithHttpInfo($obj_id, $file, string $contentType = self::contentTypes['v30StorageObjIdFileContentPut'][0])
    {
        $request = $this->v30StorageObjIdFileContentPutRequest($obj_id, $file, $contentType);
    ...
    /**
     * Operation v30StorageObjIdFileContentPutAsync
     *
     * Upload a file to an existing storage object
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdFileContentPutAsync($obj_id, $file, string $contentType = self::contentTypes['v30StorageObjIdFileContentPut'][0])
    {
        return $this->v30StorageObjIdFileContentPutAsyncWithHttpInfo($obj_id, $file, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageObjIdFileContentPutAsyncWithHttpInfo
     *
     * Upload a file to an existing storage object
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdFileContentPutAsyncWithHttpInfo($obj_id, $file, string $contentType = self::contentTypes['v30StorageObjIdFileContentPut'][0])
    {
        $returnType = '';
        $request = $this->v30StorageObjIdFileContentPutRequest($obj_id, $file, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageObjIdFileContentPut'
     *
     * @param  int $obj_id (required)
     * @param  mixed|null $file The file to upload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdFileContentPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageObjIdFileContentPutRequest($obj_id, $file, string $contentType = self::contentTypes['v30StorageObjIdFileContentPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30StorageObjIdFileContentPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling StorageApi.v30StorageObjIdFileContentPut, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'file' is set
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling v30StorageObjIdFileContentPut'
            );
        }


        $resourcePath = '/v30/storage/{obj_id}/file-content';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30StorageObjIdGet
     *
     * Retrieve StorageObject
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObject
     */
    public function v30StorageObjIdGet($obj_id, string $contentType = self::contentTypes['v30StorageObjIdGet'][0])
    {
        list($response) = $this->v30StorageObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageObjIdGetWithHttpInfo
     *
     * Retrieve StorageObject
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageObjIdGet'][0])
    {
        $request = $this->v30StorageObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\StorageObject',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30StorageObjIdGetAsync
     *
     * Retrieve StorageObject
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30StorageObjIdGet'][0])
    {
        return $this->v30StorageObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageObjIdGetAsyncWithHttpInfo
     *
     * Retrieve StorageObject
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30StorageObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageObject';
        $request = $this->v30StorageObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30StorageObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30StorageObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling StorageApi.v30StorageObjIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30StorageObjIdPut
     *
     * Update StorageObject
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $storage_object storage_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObject
     */
    public function v30StorageObjIdPut($obj_id, $storage_object = null, string $contentType = self::contentTypes['v30StorageObjIdPut'][0])
    {
        list($response) = $this->v30StorageObjIdPutWithHttpInfo($obj_id, $storage_object, $contentType);
        return $response;
    }

    /**
     * Operation v30StorageObjIdPutWithHttpInfo
     *
     * Update StorageObject
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $storage_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StorageObjIdPutWithHttpInfo($obj_id, $storage_object = null, string $contentType = self::contentTypes['v30StorageObjIdPut'][0])
    {
        $request = $this->v30StorageObjIdPutRequest($obj_id, $storage_object, $contentType);
    ...
    /**
     * Operation v30StorageObjIdPutAsync
     *
     * Update StorageObject
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdPutAsync($obj_id, $storage_object = null, string $contentType = self::contentTypes['v30StorageObjIdPut'][0])
    {
        return $this->v30StorageObjIdPutAsyncWithHttpInfo($obj_id, $storage_object, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StorageObjIdPutAsyncWithHttpInfo
     *
     * Update StorageObject
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StorageObjIdPutAsyncWithHttpInfo($obj_id, $storage_object = null, string $contentType = self::contentTypes['v30StorageObjIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageObject';
        $request = $this->v30StorageObjIdPutRequest($obj_id, $storage_object, $contentType);
    ...
    /**
     * Create request for operation 'v30StorageObjIdPut'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $storage_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StorageObjIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StorageObjIdPutRequest($obj_id, $storage_object = null, string $contentType = self::contentTypes['v30StorageObjIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30StorageObjIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling StorageApi.v30StorageObjIdPut, must be bigger than or equal to 0.');
        }
        ...
        // for model (json/xml)
        if (isset($storage_object)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($storage_object));
            } else {
                $httpBody = $storage_object;
            }
    ...
    /**
     * Operation v30StoragePost
     *
     * Create StorageObject
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $storage_object storage_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StoragePost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObject
     */
    public function v30StoragePost($storage_object = null, string $contentType = self::contentTypes['v30StoragePost'][0])
    {
        list($response) = $this->v30StoragePostWithHttpInfo($storage_object, $contentType);
        return $response;
    }

    /**
     * Operation v30StoragePostWithHttpInfo
     *
     * Create StorageObject
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $storage_object (optional)
     ...
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\StorageObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30StoragePostWithHttpInfo($storage_object = null, string $contentType = self::contentTypes['v30StoragePost'][0])
    {
        $request = $this->v30StoragePostRequest($storage_object, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StoragePostAsync($storage_object = null, string $contentType = self::contentTypes['v30StoragePost'][0])
    {
        return $this->v30StoragePostAsyncWithHttpInfo($storage_object, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30StoragePostAsyncWithHttpInfo
     *
     * Create StorageObject
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $storage_object (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30StoragePostAsyncWithHttpInfo($storage_object = null, string $contentType = self::contentTypes['v30StoragePost'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\StorageObject';
        $request = $this->v30StoragePostRequest($storage_object, $contentType);
    ...
    /**
     * Create request for operation 'v30StoragePost'
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $storage_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30StoragePost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30StoragePostRequest($storage_object = null, string $contentType = self::contentTypes['v30StoragePost'][0])
    {
