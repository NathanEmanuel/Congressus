...
class ProductFoldersApi
{
    ...
    /**
     * Operation v30ProductFoldersGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolderPagination
     */
    public function v30ProductFoldersGet($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersGet'][0])
    {
        list($response) = $this->v30ProductFoldersGetWithHttpInfo($published, $parent_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductFoldersGetWithHttpInfo
     *
     * List Product folders
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolderPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductFoldersGetWithHttpInfo($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersGet'][0])
    {
        $request = $this->v30ProductFoldersGetRequest($published, $parent_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\ProductFolderPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30ProductFoldersGetAsync
     *
     * List Product folders
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     */
    public function v30ProductFoldersGetAsync($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersGet'][0])
    {
        return $this->v30ProductFoldersGetAsyncWithHttpInfo($published, $parent_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductFoldersGetAsyncWithHttpInfo
     *
     * List Product folders
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersGetAsyncWithHttpInfo($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\ProductFolderPagination';
        $request = $this->v30ProductFoldersGetRequest($published, $parent_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductFoldersGet'
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string|null $parent_id (optional)
     * @param  int|null $page (optional, default to 1)
     ...
     */
    public function v30ProductFoldersGetRequest($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersGet'][0])
    {



        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ProductFoldersApi.v30ProductFoldersGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductFoldersApi.v30ProductFoldersGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductFoldersApi.v30ProductFoldersGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/product-folders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30ProductFoldersObjIdDelete
     *
     * Delete Product folder
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersObjIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30ProductFoldersObjIdDelete($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdDelete'][0])
    {
        $this->v30ProductFoldersObjIdDeleteWithHttpInfo($obj_id, $contentType);
    }

    /**
     * Operation v30ProductFoldersObjIdDeleteWithHttpInfo
     *
     * Delete Product folder
     *
     ...
     */
    public function v30ProductFoldersObjIdDeleteWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdDelete'][0])
    {
        $request = $this->v30ProductFoldersObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Operation v30ProductFoldersObjIdDeleteAsync
     *
     * Delete Product folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersObjIdDeleteAsync($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdDelete'][0])
    {
        return $this->v30ProductFoldersObjIdDeleteAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductFoldersObjIdDeleteAsyncWithHttpInfo
     *
     * Delete Product folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersObjIdDeleteAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30ProductFoldersObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductFoldersObjIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersObjIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductFoldersObjIdDeleteRequest($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductFoldersObjIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductFoldersApi.v30ProductFoldersObjIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/product-folders/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30ProductFoldersObjIdGet
     *
     * Retrieve Product folder
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolder
     */
    public function v30ProductFoldersObjIdGet($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdGet'][0])
    {
        list($response) = $this->v30ProductFoldersObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductFoldersObjIdGetWithHttpInfo
     *
     * Retrieve Product folder
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductFoldersObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdGet'][0])
    {
        $request = $this->v30ProductFoldersObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\ProductFolder',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30ProductFoldersObjIdGetAsync
     *
     * Retrieve Product folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdGet'][0])
    {
        return $this->v30ProductFoldersObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductFoldersObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Product folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\ProductFolder';
        $request = $this->v30ProductFoldersObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductFoldersObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductFoldersObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30ProductFoldersObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductFoldersObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductFoldersApi.v30ProductFoldersObjIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30ProductFoldersObjIdPut
     *
     * Update Product folder
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder product_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolder
     */
    public function v30ProductFoldersObjIdPut($obj_id, $product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersObjIdPut'][0])
    {
        list($response) = $this->v30ProductFoldersObjIdPutWithHttpInfo($obj_id, $product_folder, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductFoldersObjIdPutWithHttpInfo
     *
     * Update Product folder
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductFoldersObjIdPutWithHttpInfo($obj_id, $product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersObjIdPut'][0])
    {
        $request = $this->v30ProductFoldersObjIdPutRequest($obj_id, $product_folder, $contentType);
    ...
    /**
     * Operation v30ProductFoldersObjIdPutAsync
     *
     * Update Product folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersObjIdPutAsync($obj_id, $product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersObjIdPut'][0])
    {
        return $this->v30ProductFoldersObjIdPutAsyncWithHttpInfo($obj_id, $product_folder, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductFoldersObjIdPutAsyncWithHttpInfo
     *
     * Update Product folder
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersObjIdPutAsyncWithHttpInfo($obj_id, $product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersObjIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\ProductFolder';
        $request = $this->v30ProductFoldersObjIdPutRequest($obj_id, $product_folder, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductFoldersObjIdPut'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersObjIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductFoldersObjIdPutRequest($obj_id, $product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersObjIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30ProductFoldersObjIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling ProductFoldersApi.v30ProductFoldersObjIdPut, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30ProductFoldersPost
     *
     * Create Product folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder product_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolder
     */
    public function v30ProductFoldersPost($product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersPost'][0])
    {
        list($response) = $this->v30ProductFoldersPostWithHttpInfo($product_folder, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductFoldersPostWithHttpInfo
     *
     * Create Product folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder (optional)
     ...
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductFoldersPostWithHttpInfo($product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersPost'][0])
    {
        $request = $this->v30ProductFoldersPostRequest($product_folder, $contentType);
    ...
    /**
     * Operation v30ProductFoldersPostAsync
     *
     * Create Product folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersPostAsync($product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersPost'][0])
    {
        return $this->v30ProductFoldersPostAsyncWithHttpInfo($product_folder, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductFoldersPostAsyncWithHttpInfo
     *
     * Create Product folder
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersPostAsyncWithHttpInfo($product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersPost'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\ProductFolder';
        $request = $this->v30ProductFoldersPostRequest($product_folder, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductFoldersPost'
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $product_folder (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductFoldersPostRequest($product_folder = null, string $contentType = self::contentTypes['v30ProductFoldersPost'][0])
    {
    ...
    /**
     * Operation v30ProductFoldersRecursiveGet
     *
     ...
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional, default to 'name')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30ProductFoldersRecursiveGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolderListRecursivePagination
     */
    public function v30ProductFoldersRecursiveGet($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersRecursiveGet'][0])
    {
        list($response) = $this->v30ProductFoldersRecursiveGetWithHttpInfo($published, $parent_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30ProductFoldersRecursiveGetWithHttpInfo
     *
     * List Product folders - recursive
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\ProductFolderListRecursivePagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30ProductFoldersRecursiveGetWithHttpInfo($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersRecursiveGet'][0])
    {
        $request = $this->v30ProductFoldersRecursiveGetRequest($published, $parent_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\ProductFolderListRecursivePagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30ProductFoldersRecursiveGetAsync
     *
     * List Product folders - recursive
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersRecursiveGetAsync($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersRecursiveGet'][0])
    {
        return $this->v30ProductFoldersRecursiveGetAsyncWithHttpInfo($published, $parent_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30ProductFoldersRecursiveGetAsyncWithHttpInfo
     *
     * List Product folders - recursive
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30ProductFoldersRecursiveGetAsyncWithHttpInfo($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersRecursiveGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\ProductFolderListRecursivePagination';
        $request = $this->v30ProductFoldersRecursiveGetRequest($published, $parent_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30ProductFoldersRecursiveGet'
     *
     * @param  string|null $published Filter on &#x60;published&#x60; (optional)
     * @param  string|null $parent_id (optional)
     * @param  int|null $page (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30ProductFoldersRecursiveGetRequest($published = null, $parent_id = null, $page = 1, $page_size = 25, $order = 'name', string $contentType = self::contentTypes['v30ProductFoldersRecursiveGet'][0])
    {



        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ProductFoldersApi.v30ProductFoldersRecursiveGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductFoldersApi.v30ProductFoldersRecursiveGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProductFoldersApi.v30ProductFoldersRecursiveGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/product-folders/recursive';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
