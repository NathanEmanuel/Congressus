...
class CountriesApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30CountriesGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\CountryPagination
     */
    public function v30CountriesGet($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30CountriesGet'][0])
    {
        list($response) = $this->v30CountriesGetWithHttpInfo($page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30CountriesGetWithHttpInfo
     *
     * List Countries
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\CountryPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30CountriesGetWithHttpInfo($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30CountriesGet'][0])
    {
        $request = $this->v30CountriesGetRequest($page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\CountryPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30CountriesGetAsync
     *
     * List Countries
     *
     * @param  int|null $page (optional, default to 1)
     ...
     */
    public function v30CountriesGetAsync($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30CountriesGet'][0])
    {
        return $this->v30CountriesGetAsyncWithHttpInfo($page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30CountriesGetAsyncWithHttpInfo
     *
     * List Countries
     *
     * @param  int|null $page (optional, default to 1)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30CountriesGetAsyncWithHttpInfo($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30CountriesGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\CountryPagination';
        $request = $this->v30CountriesGetRequest($page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30CountriesGet'
     *
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     * @param  string|null $order (optional)
     ...
     */
    public function v30CountriesGetRequest($page = 1, $page_size = 25, $order = null, string $contentType = self::contentTypes['v30CountriesGet'][0])
    {

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling CountriesApi.v30CountriesGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling CountriesApi.v30CountriesGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling CountriesApi.v30CountriesGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/countries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30CountriesObjIdGet
     *
     * Retrieve Country
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30CountriesObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Country
     */
    public function v30CountriesObjIdGet($obj_id, string $contentType = self::contentTypes['v30CountriesObjIdGet'][0])
    {
        list($response) = $this->v30CountriesObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30CountriesObjIdGetWithHttpInfo
     *
     * Retrieve Country
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Country, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30CountriesObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30CountriesObjIdGet'][0])
    {
        $request = $this->v30CountriesObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\Country',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30CountriesObjIdGetAsync
     *
     * Retrieve Country
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30CountriesObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30CountriesObjIdGet'][0])
    {
        return $this->v30CountriesObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30CountriesObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Country
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30CountriesObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30CountriesObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\Country';
        $request = $this->v30CountriesObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30CountriesObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30CountriesObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30CountriesObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30CountriesObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30CountriesObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling CountriesApi.v30CountriesObjIdGet, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/countries/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
