...
/**
 * GalleriesApi Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
...
class GalleriesApi
{
    ...
    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosGet
     *
     * List Gallery photos
     *
     * @param  int $album_id album_id (required)
     * @param  int|null $page page (optional, default to 1)
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional, default to 'order')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryPhotoPagination
     */
    public function v30GalleriesAlbumsAlbumIdPhotosGet($album_id, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosGet'][0])
    {
        list($response) = $this->v30GalleriesAlbumsAlbumIdPhotosGetWithHttpInfo($album_id, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosGetWithHttpInfo
     *
     * List Gallery photos
     *
     * @param  int $album_id (required)
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     * @param  string|null $order (optional, default to 'order')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryPhotoPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30GalleriesAlbumsAlbumIdPhotosGetWithHttpInfo($album_id, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosGet'][0])
    {
        $request = $this->v30GalleriesAlbumsAlbumIdPhotosGetRequest($album_id, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\GalleryPhotoPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosGetAsync
     *
     * List Gallery photos
     *
     * @param  int $album_id (required)
     ...
     */
    public function v30GalleriesAlbumsAlbumIdPhotosGetAsync($album_id, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosGet'][0])
    {
        return $this->v30GalleriesAlbumsAlbumIdPhotosGetAsyncWithHttpInfo($album_id, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosGetAsyncWithHttpInfo
     *
     * List Gallery photos
     *
     * @param  int $album_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30GalleriesAlbumsAlbumIdPhotosGetAsyncWithHttpInfo($album_id, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\GalleryPhotoPagination';
        $request = $this->v30GalleriesAlbumsAlbumIdPhotosGetRequest($album_id, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30GalleriesAlbumsAlbumIdPhotosGet'
     *
     * @param  int $album_id (required)
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     ...
     */
    public function v30GalleriesAlbumsAlbumIdPhotosGetRequest($album_id, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosGet'][0])
    {

        // verify the required parameter 'album_id' is set
        if ($album_id === null || (is_array($album_id) && count($album_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $album_id when calling v30GalleriesAlbumsAlbumIdPhotosGet'
            );
        }
        if ($album_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$album_id" when calling GalleriesApi.v30GalleriesAlbumsAlbumIdPhotosGet, must be bigger than or equal to 0.');
        }
        
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling GalleriesApi.v30GalleriesAlbumsAlbumIdPhotosGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling GalleriesApi.v30GalleriesAlbumsAlbumIdPhotosGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling GalleriesApi.v30GalleriesAlbumsAlbumIdPhotosGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/galleries/albums/{album_id}/photos';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($album_id !== null) {
            $resourcePath = str_replace(
                '{' . 'album_id' . '}',
                ObjectSerializer::toPathValue($album_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosObjIdGet
     *
     * Retrieve Gallery photo
     *
     * @param  int $obj_id obj_id (required)
     * @param  int $album_id album_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryPhoto
     */
    public function v30GalleriesAlbumsAlbumIdPhotosObjIdGet($obj_id, $album_id, string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosObjIdGet'][0])
    {
        list($response) = $this->v30GalleriesAlbumsAlbumIdPhotosObjIdGetWithHttpInfo($obj_id, $album_id, $contentType);
        return $response;
    }

    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosObjIdGetWithHttpInfo
     *
     * Retrieve Gallery photo
     *
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryPhoto, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30GalleriesAlbumsAlbumIdPhotosObjIdGetWithHttpInfo($obj_id, $album_id, string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosObjIdGet'][0])
    {
        $request = $this->v30GalleriesAlbumsAlbumIdPhotosObjIdGetRequest($obj_id, $album_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\GalleryPhoto',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosObjIdGetAsync
     *
     * Retrieve Gallery photo
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30GalleriesAlbumsAlbumIdPhotosObjIdGetAsync($obj_id, $album_id, string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosObjIdGet'][0])
    {
        return $this->v30GalleriesAlbumsAlbumIdPhotosObjIdGetAsyncWithHttpInfo($obj_id, $album_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30GalleriesAlbumsAlbumIdPhotosObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Gallery photo
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30GalleriesAlbumsAlbumIdPhotosObjIdGetAsyncWithHttpInfo($obj_id, $album_id, string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\GalleryPhoto';
        $request = $this->v30GalleriesAlbumsAlbumIdPhotosObjIdGetRequest($obj_id, $album_id, $contentType);
    ...
    /**
     * Create request for operation 'v30GalleriesAlbumsAlbumIdPhotosObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  int $album_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosObjIdGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30GalleriesAlbumsAlbumIdPhotosObjIdGetRequest($obj_id, $album_id, string $contentType = self::contentTypes['v30GalleriesAlbumsAlbumIdPhotosObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30GalleriesAlbumsAlbumIdPhotosObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling GalleriesApi.v30GalleriesAlbumsAlbumIdPhotosObjIdGet, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'album_id' is set
        if ($album_id === null || (is_array($album_id) && count($album_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $album_id when calling v30GalleriesAlbumsAlbumIdPhotosObjIdGet'
            );
        }
        if ($album_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$album_id" when calling GalleriesApi.v30GalleriesAlbumsAlbumIdPhotosObjIdGet, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/galleries/albums/{album_id}/photos/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30GalleriesAlbumsGet
     *
     * List Gallery albums
     *
     * @param  string|null $socie_app Filter on &#x60;filter_id&#x60;, &#x60;published&#x60; (optional)
     * @param  int|null $page page (optional, default to 1)
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional, default to 'order')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30GalleriesAlbumsGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryAlbumPagination
     */
    public function v30GalleriesAlbumsGet($socie_app = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsGet'][0])
    {
        list($response) = $this->v30GalleriesAlbumsGetWithHttpInfo($socie_app, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30GalleriesAlbumsGetWithHttpInfo
     *
     * List Gallery albums
     *
     * @param  string|null $socie_app Filter on &#x60;filter_id&#x60;, &#x60;published&#x60; (optional)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryAlbumPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30GalleriesAlbumsGetWithHttpInfo($socie_app = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsGet'][0])
    {
        $request = $this->v30GalleriesAlbumsGetRequest($socie_app, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\GalleryAlbumPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30GalleriesAlbumsGetAsync
     *
     * List Gallery albums
     *
     * @param  string|null $socie_app Filter on &#x60;filter_id&#x60;, &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30GalleriesAlbumsGetAsync($socie_app = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsGet'][0])
    {
        return $this->v30GalleriesAlbumsGetAsyncWithHttpInfo($socie_app, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30GalleriesAlbumsGetAsyncWithHttpInfo
     *
     * List Gallery albums
     *
     * @param  string|null $socie_app Filter on &#x60;filter_id&#x60;, &#x60;published&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30GalleriesAlbumsGetAsyncWithHttpInfo($socie_app = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\GalleryAlbumPagination';
        $request = $this->v30GalleriesAlbumsGetRequest($socie_app, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30GalleriesAlbumsGet'
     *
     * @param  string|null $socie_app Filter on &#x60;filter_id&#x60;, &#x60;published&#x60; (optional)
     * @param  int|null $page (optional, default to 1)
     * @param  int|null $page_size (optional, default to 25)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30GalleriesAlbumsGetRequest($socie_app = null, $page = 1, $page_size = 25, $order = 'order', string $contentType = self::contentTypes['v30GalleriesAlbumsGet'][0])
    {


        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling GalleriesApi.v30GalleriesAlbumsGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling GalleriesApi.v30GalleriesAlbumsGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling GalleriesApi.v30GalleriesAlbumsGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/galleries/albums';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30GalleriesAlbumsObjIdGet
     *
     * Retrieve Gallery album
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30GalleriesAlbumsObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryAlbum
     */
    public function v30GalleriesAlbumsObjIdGet($obj_id, string $contentType = self::contentTypes['v30GalleriesAlbumsObjIdGet'][0])
    {
        list($response) = $this->v30GalleriesAlbumsObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30GalleriesAlbumsObjIdGetWithHttpInfo
     *
     * Retrieve Gallery album
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\GalleryAlbum, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30GalleriesAlbumsObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30GalleriesAlbumsObjIdGet'][0])
    {
        $request = $this->v30GalleriesAlbumsObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\GalleryAlbum',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30GalleriesAlbumsObjIdGetAsync
     *
     * Retrieve Gallery album
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30GalleriesAlbumsObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30GalleriesAlbumsObjIdGet'][0])
    {
        return $this->v30GalleriesAlbumsObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30GalleriesAlbumsObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Gallery album
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30GalleriesAlbumsObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30GalleriesAlbumsObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\GalleryAlbum';
        $request = $this->v30GalleriesAlbumsObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30GalleriesAlbumsObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30GalleriesAlbumsObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30GalleriesAlbumsObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30GalleriesAlbumsObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30GalleriesAlbumsObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling GalleriesApi.v30GalleriesAlbumsObjIdGet, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/galleries/albums/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
