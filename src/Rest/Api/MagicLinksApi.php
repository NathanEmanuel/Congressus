...
class MagicLinksApi
{
    ...
    /**
     * Operation v30MagicLinksPost
     *
     * Create MagicLink
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\MagicLink|null $magic_link magic_link (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MagicLinksPost'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MagicLink
     */
    public function v30MagicLinksPost($magic_link = null, string $contentType = self::contentTypes['v30MagicLinksPost'][0])
    {
        list($response) = $this->v30MagicLinksPostWithHttpInfo($magic_link, $contentType);
        return $response;
    }

    /**
     * Operation v30MagicLinksPostWithHttpInfo
     *
     * Create MagicLink
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\MagicLink|null $magic_link (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MagicLinksPost'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MagicLink, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30MagicLinksPostWithHttpInfo($magic_link = null, string $contentType = self::contentTypes['v30MagicLinksPost'][0])
    {
        $request = $this->v30MagicLinksPostRequest($magic_link, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 201:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\MagicLink',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30MagicLinksPostAsync
     *
     * Create MagicLink
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\MagicLink|null $magic_link (optional)
     ...
     */
    public function v30MagicLinksPostAsync($magic_link = null, string $contentType = self::contentTypes['v30MagicLinksPost'][0])
    {
        return $this->v30MagicLinksPostAsyncWithHttpInfo($magic_link, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30MagicLinksPostAsyncWithHttpInfo
     *
     * Create MagicLink
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\MagicLink|null $magic_link (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MagicLinksPostAsyncWithHttpInfo($magic_link = null, string $contentType = self::contentTypes['v30MagicLinksPost'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\MagicLink';
        $request = $this->v30MagicLinksPostRequest($magic_link, $contentType);
    ...
    /**
     * Create request for operation 'v30MagicLinksPost'
     *
     * @param  \NathanEmanuel\Congressus\Rest\Model\MagicLink|null $magic_link (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MagicLinksPost'] to see the possible values for this operation
     *
     ...
     */
    public function v30MagicLinksPostRequest($magic_link = null, string $contentType = self::contentTypes['v30MagicLinksPost'][0])
    {



        $resourcePath = '/v30/magic-links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($magic_link)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($magic_link));
            } else {
                $httpBody = $magic_link;
            }
