...
/**
 * MemberStatusesApi Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
...
class MemberStatusesApi
{
    ...
    /**
     * Operation v30MemberStatusesGet
     *
     * List Member statuses
     *
     * @param  string|null $archived Filter on &#x60;archived&#x60; (optional)
     * @param  string|null $hidden Filter on &#x60;hidden&#x60; (optional)
     * @param  string|null $deceased Filter on &#x60;is_deceased&#x60; (optional)
     * @param  int|null $page page (optional, default to 1)
     * @param  int|null $page_size page_size (optional, default to 25)
     * @param  string|null $order order (optional, default to 'hidden:asc,archived:asc,order:asc,name:asc')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesGet'] to see the possible values for this operation
     *
     ...
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MemberStatusListPagination
     */
    public function v30MemberStatusesGet($archived = null, $hidden = null, $deceased = null, $page = 1, $page_size = 25, $order = 'hidden:asc,archived:asc,order:asc,name:asc', string $contentType = self::contentTypes['v30MemberStatusesGet'][0])
    {
        list($response) = $this->v30MemberStatusesGetWithHttpInfo($archived, $hidden, $deceased, $page, $page_size, $order, $contentType);
        return $response;
    }

    /**
     * Operation v30MemberStatusesGetWithHttpInfo
     *
     * List Member statuses
     *
     * @param  string|null $archived Filter on &#x60;archived&#x60; (optional)
     ...
     * @param  string|null $order (optional, default to 'hidden:asc,archived:asc,order:asc,name:asc')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MemberStatusListPagination, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30MemberStatusesGetWithHttpInfo($archived = null, $hidden = null, $deceased = null, $page = 1, $page_size = 25, $order = 'hidden:asc,archived:asc,order:asc,name:asc', string $contentType = self::contentTypes['v30MemberStatusesGet'][0])
    {
        $request = $this->v30MemberStatusesGetRequest($archived, $hidden, $deceased, $page, $page_size, $order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\MemberStatusListPagination',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30MemberStatusesGetAsync
     *
     * List Member statuses
     *
     * @param  string|null $archived Filter on &#x60;archived&#x60; (optional)
     ...
     */
    public function v30MemberStatusesGetAsync($archived = null, $hidden = null, $deceased = null, $page = 1, $page_size = 25, $order = 'hidden:asc,archived:asc,order:asc,name:asc', string $contentType = self::contentTypes['v30MemberStatusesGet'][0])
    {
        return $this->v30MemberStatusesGetAsyncWithHttpInfo($archived, $hidden, $deceased, $page, $page_size, $order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30MemberStatusesGetAsyncWithHttpInfo
     *
     * List Member statuses
     *
     * @param  string|null $archived Filter on &#x60;archived&#x60; (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MemberStatusesGetAsyncWithHttpInfo($archived = null, $hidden = null, $deceased = null, $page = 1, $page_size = 25, $order = 'hidden:asc,archived:asc,order:asc,name:asc', string $contentType = self::contentTypes['v30MemberStatusesGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\MemberStatusListPagination';
        $request = $this->v30MemberStatusesGetRequest($archived, $hidden, $deceased, $page, $page_size, $order, $contentType);
    ...
    /**
     * Create request for operation 'v30MemberStatusesGet'
     *
     * @param  string|null $archived Filter on &#x60;archived&#x60; (optional)
     * @param  string|null $hidden Filter on &#x60;hidden&#x60; (optional)
     * @param  string|null $deceased Filter on &#x60;is_deceased&#x60; (optional)
     ...
     */
    public function v30MemberStatusesGetRequest($archived = null, $hidden = null, $deceased = null, $page = 1, $page_size = 25, $order = 'hidden:asc,archived:asc,order:asc,name:asc', string $contentType = self::contentTypes['v30MemberStatusesGet'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling MemberStatusesApi.v30MemberStatusesGet, must be bigger than or equal to 1.');
        }
        
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MemberStatusesApi.v30MemberStatusesGet, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling MemberStatusesApi.v30MemberStatusesGet, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/v30/member-statuses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30MemberStatusesObjIdDelete
     *
     * Delete Member status
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesObjIdDelete'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function v30MemberStatusesObjIdDelete($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdDelete'][0])
    {
        $this->v30MemberStatusesObjIdDeleteWithHttpInfo($obj_id, $contentType);
    }

    /**
     * Operation v30MemberStatusesObjIdDeleteWithHttpInfo
     *
     * Delete Member status
     *
     ...
     */
    public function v30MemberStatusesObjIdDeleteWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdDelete'][0])
    {
        $request = $this->v30MemberStatusesObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Operation v30MemberStatusesObjIdDeleteAsync
     *
     * Delete Member status
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MemberStatusesObjIdDeleteAsync($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdDelete'][0])
    {
        return $this->v30MemberStatusesObjIdDeleteAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30MemberStatusesObjIdDeleteAsyncWithHttpInfo
     *
     * Delete Member status
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MemberStatusesObjIdDeleteAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdDelete'][0])
    {
        $returnType = '';
        $request = $this->v30MemberStatusesObjIdDeleteRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30MemberStatusesObjIdDelete'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesObjIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30MemberStatusesObjIdDeleteRequest($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdDelete'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30MemberStatusesObjIdDelete'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling MemberStatusesApi.v30MemberStatusesObjIdDelete, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v30/member-statuses/{obj_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation v30MemberStatusesObjIdGet
     *
     * Retrieve Member status
     *
     * @param  int $obj_id obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesObjIdGet'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings
     */
    public function v30MemberStatusesObjIdGet($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdGet'][0])
    {
        list($response) = $this->v30MemberStatusesObjIdGetWithHttpInfo($obj_id, $contentType);
        return $response;
    }

    /**
     * Operation v30MemberStatusesObjIdGetWithHttpInfo
     *
     * Retrieve Member status
     *
     * @param  int $obj_id (required)
     ...
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30MemberStatusesObjIdGetWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdGet'][0])
    {
        $request = $this->v30MemberStatusesObjIdGetRequest($obj_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation v30MemberStatusesObjIdGetAsync
     *
     * Retrieve Member status
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MemberStatusesObjIdGetAsync($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdGet'][0])
    {
        return $this->v30MemberStatusesObjIdGetAsyncWithHttpInfo($obj_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30MemberStatusesObjIdGetAsyncWithHttpInfo
     *
     * Retrieve Member status
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MemberStatusesObjIdGetAsyncWithHttpInfo($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdGet'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings';
        $request = $this->v30MemberStatusesObjIdGetRequest($obj_id, $contentType);
    ...
    /**
     * Create request for operation 'v30MemberStatusesObjIdGet'
     *
     * @param  int $obj_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesObjIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30MemberStatusesObjIdGetRequest($obj_id, string $contentType = self::contentTypes['v30MemberStatusesObjIdGet'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30MemberStatusesObjIdGet'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling MemberStatusesApi.v30MemberStatusesObjIdGet, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation v30MemberStatusesObjIdPut
     *
     * Update Member status
     *
     * @param  int $obj_id obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings|null $member_status_with_field_settings member_status_with_field_settings (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings
     */
    public function v30MemberStatusesObjIdPut($obj_id, $member_status_with_field_settings = null, string $contentType = self::contentTypes['v30MemberStatusesObjIdPut'][0])
    {
        list($response) = $this->v30MemberStatusesObjIdPutWithHttpInfo($obj_id, $member_status_with_field_settings, $contentType);
        return $response;
    }

    /**
     * Operation v30MemberStatusesObjIdPutWithHttpInfo
     *
     * Update Member status
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings|null $member_status_with_field_settings (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesObjIdPut'] to see the possible values for this operation
     *
     * @throws \NathanEmanuel\Congressus\Rest\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\Error|\NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function v30MemberStatusesObjIdPutWithHttpInfo($obj_id, $member_status_with_field_settings = null, string $contentType = self::contentTypes['v30MemberStatusesObjIdPut'][0])
    {
        $request = $this->v30MemberStatusesObjIdPutRequest($obj_id, $member_status_with_field_settings, $contentType);
    ...
    /**
     * Operation v30MemberStatusesObjIdPutAsync
     *
     * Update Member status
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MemberStatusesObjIdPutAsync($obj_id, $member_status_with_field_settings = null, string $contentType = self::contentTypes['v30MemberStatusesObjIdPut'][0])
    {
        return $this->v30MemberStatusesObjIdPutAsyncWithHttpInfo($obj_id, $member_status_with_field_settings, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v30MemberStatusesObjIdPutAsyncWithHttpInfo
     *
     * Update Member status
     *
     * @param  int $obj_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v30MemberStatusesObjIdPutAsyncWithHttpInfo($obj_id, $member_status_with_field_settings = null, string $contentType = self::contentTypes['v30MemberStatusesObjIdPut'][0])
    {
        $returnType = '\NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings';
        $request = $this->v30MemberStatusesObjIdPutRequest($obj_id, $member_status_with_field_settings, $contentType);
    ...
    /**
     * Create request for operation 'v30MemberStatusesObjIdPut'
     *
     * @param  int $obj_id (required)
     * @param  \NathanEmanuel\Congressus\Rest\Model\MemberStatusWithFieldSettings|null $member_status_with_field_settings (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v30MemberStatusesObjIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v30MemberStatusesObjIdPutRequest($obj_id, $member_status_with_field_settings = null, string $contentType = self::contentTypes['v30MemberStatusesObjIdPut'][0])
    {

        // verify the required parameter 'obj_id' is set
        if ($obj_id === null || (is_array($obj_id) && count($obj_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $obj_id when calling v30MemberStatusesObjIdPut'
            );
        }
        if ($obj_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$obj_id" when calling MemberStatusesApi.v30MemberStatusesObjIdPut, must be bigger than or equal to 0.');
        }
        ...
        // for model (json/xml)
        if (isset($member_status_with_field_settings)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($member_status_with_field_settings));
            } else {
                $httpBody = $member_status_with_field_settings;
            }
