...
/**
 * ClientEntity Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class ClientEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientEntity';
    ...
    */
     ...
     * Sets client_id
     *
     * @param mixed|null $client_id client_id
     *
     * @return self
     */
     ...
     * Sets coc_number
     *
     * @param mixed|null $coc_number coc_number
     *
     * @return self
     */
