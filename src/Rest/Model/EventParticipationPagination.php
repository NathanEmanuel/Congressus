...
/**
 * EventParticipationPagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class EventParticipationPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventParticipationPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\EventParticipation[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\EventParticipation[]|null
     */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\EventParticipation[]|null $data data
     *
     * @return self
     */
