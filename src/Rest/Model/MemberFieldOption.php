...
/**
 * MemberFieldOption Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class MemberFieldOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberFieldOption';
    ...
    */
     ...
     * Sets option_value
     *
     * @param string|null $option_value option_value
     *
     * @return self
     */
