<?php
/**
 * OrganisationCategoryWithCustomFieldMetadata
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * OrganisationCategoryWithCustomFieldMetadata Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class OrganisationCategoryWithCustomFieldMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganisationCategoryWithCustomFieldMetadata';
    ...
    protected static $openAPITypes = [
        ...
        'order_type' => 'string',
        'custom_fields' => '\NathanEmanuel\Congressus\Rest\Model\CustomFormField[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OrganisationCategoryWithCustomFieldMetadata., must be smaller than or equal to 255.');
        }
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (mb_strlen($color) > 16)) {
            throw new \InvalidArgumentException('invalid length for $color when calling OrganisationCategoryWithCustomFieldMetadata., must be smaller than or equal to 16.');
        }
    ...
    public function setVisibility($visibility)
    {
        ...
        if (!is_null($visibility) && (mb_strlen($visibility) > 9)) {
            throw new \InvalidArgumentException('invalid length for $visibility when calling OrganisationCategoryWithCustomFieldMetadata., must be smaller than or equal to 9.');
        }
     ...
     * Gets custom_fields
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\CustomFormField[]|null
     */
     ...
     * Sets custom_fields
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\CustomFormField[]|null $custom_fields custom_fields
     *
     * @return self
     */
