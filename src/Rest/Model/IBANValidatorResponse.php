...
/**
 * IBANValidatorResponse Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class IBANValidatorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IBANValidatorResponse';
    ...
    */
    ...
    public function setIbanFormatted($iban_formatted)
    {
        if (is_null($iban_formatted)) {
            throw new \InvalidArgumentException('non-nullable iban_formatted cannot be null');
        }
