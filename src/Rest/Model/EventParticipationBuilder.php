...
class EventParticipationBuilder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'addressee' => 'string',
        'email' => 'string',
        'tickets' => '\NathanEmanuel\Congressus\Rest\Model\EventParticipationBuilderTicket[]',
        'member_id' => 'int',
        'remarks' => 'string',
        'invoice_addressee' => 'string',
        'invoice_email' => 'string',
        'invoice_invoice_reference' => 'string',
        'invoice_address' => '\NathanEmanuel\Congressus\Rest\Model\Address'
    ];
    ...
    */
     ...
     * Gets tickets
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\EventParticipationBuilderTicket[]
     */
     ...
     * Sets tickets
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\EventParticipationBuilderTicket[] $tickets tickets
     *
     * @return self
     */
     ...
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\Address|null $invoice_address invoice_address
     *
     * @return self
     */
