 ...
 */
class GroupFolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupFolder';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GroupFolder., must be smaller than or equal to 255.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 255)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling GroupFolder., must be smaller than or equal to 255.');
        }
