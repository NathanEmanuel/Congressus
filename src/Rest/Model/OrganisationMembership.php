...
/**
 * OrganisationMembership Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class OrganisationMembership implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganisationMembership';
    ...
    protected static $openAPITypes = [
        ...
        'order' => 'int',
        'organisation_id' => 'int',
        'organisation' => '\NathanEmanuel\Congressus\Rest\Model\Group'
    ];
    ...
    */
    ...
    public function setFunction($function)
    {
        ...
        if (!is_null($function) && (mb_strlen($function) > 255)) {
            throw new \InvalidArgumentException('invalid length for $function when calling OrganisationMembership., must be smaller than or equal to 255.');
        }
     ...
     * Gets organisation
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\Group|null
     */
     ...
     * Sets organisation
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\Group|null $organisation organisation
     *
     * @return self
     */
