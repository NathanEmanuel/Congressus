...
class EventParticipationTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ticket_type_id' => 'int',
        'ticket_type' => '\NathanEmanuel\Congressus\Rest\Model\EventTicketType'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ticket_type_id'] === null) {
            $invalidProperties[] = "'ticket_type_id' can't be null";
        }
     ...
     * Sets ticket_type
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\EventTicketType|null $ticket_type ticket_type
     *
     * @return self
     */
