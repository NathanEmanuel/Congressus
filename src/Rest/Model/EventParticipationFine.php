...
/**
 * EventParticipationFine Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class EventParticipationFine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventParticipationFine';
    ...
    protected static $setters = [
        'fine_percentage' => 'setFinePercentage'
    ];
    ...
    protected static $getters = [
        'fine_percentage' => 'getFinePercentage'
    ];
    ...
    {
        $this->setIfExists('fine_percentage', $data ?? [], 0);
    }
    ...
    */
    ...
    /**
     * Gets fine_percentage
     *
     * @return int|null
     */
    public function getFinePercentage()
    {
        return $this->container['fine_percentage'];
    }

    /**
     * Sets fine_percentage
     *
     * @param int|null $fine_percentage Percentage of the ticket price that is charged as a fine. Set to 0 to disable fines.
     *
     * @return self
     */
    public function setFinePercentage($fine_percentage)
    {
        if (is_null($fine_percentage)) {
            throw new \InvalidArgumentException('non-nullable fine_percentage cannot be null');
        }
        $this->container['fine_percentage'] = $fine_percentage;
