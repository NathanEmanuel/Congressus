...
class EventCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'color' => 'string',
        'entity' => '\NathanEmanuel\Congressus\Rest\Model\ClientEntity',
        'show_in_overview' => 'bool',
        'attach_ical_to_mails' => 'bool',
        'published' => 'bool',
        'visibility' => 'string',
        'filter' => '\NathanEmanuel\Congressus\Rest\Model\BasicFilter',
    ...
    protected static $attributeMap = [
        ...
        'attach_ical_to_mails' => 'attach_ical_to_mails',
        'published' => 'published',
    ...
    protected static $setters = [
        ...
        'attach_ical_to_mails' => 'setAttachIcalToMails',
    ...
    protected static $getters = [
        ...
        'attach_ical_to_mails' => 'getAttachIcalToMails',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('attach_ical_to_mails', $data ?? [], null);
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EventCategory., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EventCategory., must be bigger than or equal to 1.');
        }
     ...
     * Sets color
     *
     * @param string|null $color Custom hex-color for this category
     *
     * @return self
     */
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (mb_strlen($color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $color when calling EventCategory., must be smaller than or equal to 7.');
        }
        if (!is_null($color) && (!preg_match("/^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling EventCategory., must conform to the pattern /^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/.");
        }
     ...
     * Gets entity
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\ClientEntity|null
     */
     ...
     * Sets entity
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\ClientEntity|null $entity entity
     *
     * @return self
     */
     ...
     *
     * @param bool|null $show_in_overview Show this category in the overview
     *
     * @return self
     */
    ...
    /**
     * Gets attach_ical_to_mails
     *
     * @return bool|null
     */
    public function getAttachIcalToMails()
    {
        return $this->container['attach_ical_to_mails'];
    }

    /**
     * Sets attach_ical_to_mails
     *
     * @param bool|null $attach_ical_to_mails Attach an ical file to mails for this category
     *
     * @return self
     */
    public function setAttachIcalToMails($attach_ical_to_mails)
    {
        if (is_null($attach_ical_to_mails)) {
            throw new \InvalidArgumentException('non-nullable attach_ical_to_mails cannot be null');
        }
        $this->container['attach_ical_to_mails'] = $attach_ical_to_mails;
     ...
     * Sets published
     *
     * @param bool|null $published Set the publication of objects in this category.
     *
     * @return self
     */
     ...
     * Sets visibility
     *
     * @param string|null $visibility Set the visibility of objects in this category.
     *
     * @return self
     */
     ...
     * Gets filter
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\BasicFilter|null
     */
     ...
     * Sets filter
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BasicFilter|null $filter filter
     *
     * @return self
     */
     ...
     * Sets websites
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BaseWebsite[]|null $websites websites
     *
     * @return self
     */
