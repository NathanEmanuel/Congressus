...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SIGNAL_MEMBER_BIRTHDAY = 'member_birthday';
    ...
    public const SIGNAL_FORM_ENTRY = 'form_entry';
    public const SIGNAL_FORM_ENTRY_ADDED = 'form_entry_added';
    public const SIGNAL_FORM_ENTRY_UPDATED = 'form_entry_updated';
    public const SIGNAL_FORM_ENTRY_DELETED = 'form_entry_deleted';
    ...
    public function getSignalAllowableValues()
    {
        return [
            ...
            self::SIGNAL_FORM_ENTRY,
            self::SIGNAL_FORM_ENTRY_ADDED,
            self::SIGNAL_FORM_ENTRY_UPDATED,
            self::SIGNAL_FORM_ENTRY_DELETED,
