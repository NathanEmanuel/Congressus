 ...
 */
class Notifications implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'messages' => '\NathanEmanuel\Congressus\Rest\Model\Message[]',
        'background_processes' => '\NathanEmanuel\Congressus\Rest\Model\BackgroundProcess[]'
    ];
    ...
    protected static $setters = [
        ...
        'background_processes' => 'setBackgroundProcesses'
    ];
    ...
    protected static $getters = [
        ...
        'background_processes' => 'getBackgroundProcesses'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('background_processes', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets messages
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\Message[]|null
     */
     ...
     * Sets messages
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\Message[]|null $messages messages
     *
     * @return self
     */
    ...
    /**
     * Gets background_processes
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\BackgroundProcess[]|null
     */
    public function getBackgroundProcesses()
    {
        return $this->container['background_processes'];
    }

    /**
     * Sets background_processes
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BackgroundProcess[]|null $background_processes background_processes
     *
     * @return self
     */
    public function setBackgroundProcesses($background_processes)
    {
        if (is_null($background_processes)) {
            throw new \InvalidArgumentException('non-nullable background_processes cannot be null');
        }
        $this->container['background_processes'] = $background_processes;
