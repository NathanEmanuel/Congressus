...
class GroupWithMemberships implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'folder_id' => 'int',
        'folder' => '\NathanEmanuel\Congressus\Rest\Model\GroupFolder',
        'name' => 'string',
        ...
        'end' => '\DateTime',
        'memo' => 'string',
        'memberships' => '\NathanEmanuel\Congressus\Rest\Model\CollectionMembership[]'
    ];
    ...
    */
     ...
     * Gets folder
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\GroupFolder|null
     */
     ...
     * Sets folder
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\GroupFolder|null $folder folder
     *
     * @return self
     */
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling GroupWithMemberships., must be smaller than or equal to 255.');
        }
     ...
     * Gets memberships
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\CollectionMembership[]|null
     */
     ...
     * Sets memberships
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\CollectionMembership[]|null $memberships memberships
     *
     * @return self
     */
