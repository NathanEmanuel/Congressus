...
class StorageObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'image_width' => 'int',
        'image_height' => 'int',
        'folder' => '\NathanEmanuel\Congressus\Rest\Model\StorageFolder'
    ];
    ...
    */
    ...
    public function setFilename($filename)
    {
        ...
        if (!is_null($filename) && (mb_strlen($filename) > 255)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling StorageObject., must be smaller than or equal to 255.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StorageObject., must be smaller than or equal to 255.');
        }
    ...
    public function setImageHeight($image_height)
    {
        if (is_null($image_height)) {
            array_push($this->openAPINullablesSetToNull, 'image_height');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('image_height', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets folder
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null
     */
     ...
     * Sets folder
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\StorageFolder|null $folder folder
     *
     * @return self
     */
