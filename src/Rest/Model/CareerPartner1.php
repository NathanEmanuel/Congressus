...
/**
 * CareerPartner1 Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class CareerPartner1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CareerPartner1';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CareerPartner1., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceReference($invoice_reference)
    {
        ...
        if ((mb_strlen($invoice_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_reference when calling CareerPartner1., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceAddresseeAttention($invoice_addressee_attention)
    {
        ...
        if ((mb_strlen($invoice_addressee_attention) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_addressee_attention when calling CareerPartner1., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceEmail($invoice_email)
    {
        ...
        if ((mb_strlen($invoice_email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_email when calling CareerPartner1., must be smaller than or equal to 255.');
        }
