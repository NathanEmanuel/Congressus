...
/**
 * CareerPartner Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class CareerPartner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CareerPartner';
    ...
    protected static $openAPITypes = [
        ...
        'published' => 'bool',
        'category_id' => 'int',
        'category' => '\NathanEmanuel\Congressus\Rest\Model\CareerPartnerCategory',
        ...
        'events' => '\NathanEmanuel\Congressus\Rest\Model\BaseEvent[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CareerPartner., must be smaller than or equal to 255.');
        }
     ...
     * Sets slug
     *
     * @param string $slug Slug for this partner, used for navigation on the website
     *
     * @return self
     */
     ...
     * Gets category
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\CareerPartnerCategory|null
     */
     ...
     * Sets category
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\CareerPartnerCategory|null $category category
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description for this partner. HTML is allowed.
     *
     * @return self
     */
     ...
     *
     * @param string|null $description_short Brief description for this partner. No HTML allowed.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email Email address for the partner
     *
     * @return self
     */
     ...
     * Sets memo
     *
     * @param string|null $memo Internal notes for this partner
     *
     * @return self
     */
    ...
    public function setInvoiceReference($invoice_reference)
    {
        ...
        if ((mb_strlen($invoice_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_reference when calling CareerPartner., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceAddresseeAttention($invoice_addressee_attention)
    {
        ...
        if ((mb_strlen($invoice_addressee_attention) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_addressee_attention when calling CareerPartner., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceEmail($invoice_email)
    {
        ...
        if ((mb_strlen($invoice_email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_email when calling CareerPartner., must be smaller than or equal to 255.');
        }
     ...
     * Gets events
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\BaseEvent[]|null
     */
     ...
     * Sets events
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BaseEvent[]|null $events events
     *
     * @return self
     */
