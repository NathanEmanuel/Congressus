...
/**
 * CreateLogEntry Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class CreateLogEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateLogEntry';
    ...
    public const ASSIGNEE_TYPE_ADMINISTRATOR = 'Administrator';
    public const ASSIGNEE_TYPE_ADMINISTRATOR_GROUP = 'AdministratorGroup';
    ...
    {
        return [
            self::ASSIGNEE_TYPE_ADMINISTRATOR,
            self::ASSIGNEE_TYPE_ADMINISTRATOR_GROUP,
        ];
    }
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $type when calling CreateLogEntry., must be smaller than or equal to 255.');
        }
    ...
    public function setSubjectType($subject_type)
    {
        ...
        if ((mb_strlen($subject_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject_type when calling CreateLogEntry., must be smaller than or equal to 255.');
        }
    ...
    public function setAssigneeType($assignee_type)
    {
        ...
        $allowedValues = $this->getAssigneeTypeAllowableValues();
        if (!in_array($assignee_type, $allowedValues, true)) {
