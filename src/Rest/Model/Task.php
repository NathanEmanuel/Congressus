    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $type when calling Task., must be smaller than or equal to 255.');
        }
    ...
    public function setSubjectType($subject_type)
    {
        ...
        if ((mb_strlen($subject_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject_type when calling Task., must be smaller than or equal to 255.');
        }
    ...
    public function setAssigneeType($assignee_type)
    {
        ...
        if (!is_null($assignee_type) && (mb_strlen($assignee_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $assignee_type when calling Task., must be smaller than or equal to 255.');
        }
