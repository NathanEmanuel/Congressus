...
/**
 * OrganisationPagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class OrganisationPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganisationPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\Organisation[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\Organisation[]|null
     */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\Organisation[]|null $data data
     *
     * @return self
     */
