...
/**
 * BlogParagraph Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class BlogParagraph implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlogParagraph';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if (!is_null($type) && (mb_strlen($type) > 63)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BlogParagraph., must be smaller than or equal to 63.');
        }
    ...
    public function setCaption($caption)
    {
        ...
        if (!is_null($caption) && (mb_strlen($caption) > 255)) {
            throw new \InvalidArgumentException('invalid length for $caption when calling BlogParagraph., must be smaller than or equal to 255.');
        }
