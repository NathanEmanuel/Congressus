 ...
 */
class RentalItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RentalItem';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'category' => '\NathanEmanuel\Congressus\Rest\Model\RentalCategory',
        'category_id' => 'int',
        'name' => 'mixed',
        'description' => 'mixed'
    ];
    ...
    */
     ...
     * Sets category
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\RentalCategory|null $category category
     *
     * @return self
     */
