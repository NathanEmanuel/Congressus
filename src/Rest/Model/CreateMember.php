 ...
 */
class CreateMember implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMember';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['primary_last_name_main'] === null) {
            $invalidProperties[] = "'primary_last_name_main' can't be null";
        }
    ...
    public function setGender($gender)
    {
        ...
        if (!is_null($gender) && (mb_strlen($gender) > 1)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling CreateMember., must be smaller than or equal to 1.');
        }
    ...
    public function setPrefix($prefix)
    {
        ...
        if (!is_null($prefix) && (mb_strlen($prefix) > 255)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setInitials($initials)
    {
        ...
        if (!is_null($initials) && (mb_strlen($initials) > 255)) {
            throw new \InvalidArgumentException('invalid length for $initials when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setNickname($nickname)
    {
        ...
        if (!is_null($nickname) && (mb_strlen($nickname) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nickname when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setGivenName($given_name)
    {
        ...
        if (!is_null($given_name) && (mb_strlen($given_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $given_name when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateMember., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string $primary_last_name_main primary_last_name_main
     *
     * @return self
     */
    public function setPrimaryLastNameMain($primary_last_name_main)
    {
        if (is_null($primary_last_name_main)) {
            throw new \InvalidArgumentException('non-nullable primary_last_name_main cannot be null');
        }
    ...
    public function setPrimaryLastNamePrefix($primary_last_name_prefix)
    {
        ...
        if (!is_null($primary_last_name_prefix) && (mb_strlen($primary_last_name_prefix) > 255)) {
            throw new \InvalidArgumentException('invalid length for $primary_last_name_prefix when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setSecondaryLastNameMain($secondary_last_name_main)
    {
        ...
        if (!is_null($secondary_last_name_main) && (mb_strlen($secondary_last_name_main) > 255)) {
            throw new \InvalidArgumentException('invalid length for $secondary_last_name_main when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setSecondaryLastNamePrefix($secondary_last_name_prefix)
    {
        ...
        if (!is_null($secondary_last_name_prefix) && (mb_strlen($secondary_last_name_prefix) > 255)) {
            throw new \InvalidArgumentException('invalid length for $secondary_last_name_prefix when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setLastNameDisplay($last_name_display)
    {
        ...
        if (!is_null($last_name_display) && (mb_strlen($last_name_display) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name_display when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setSuffix($suffix)
    {
        ...
        if (!is_null($suffix) && (mb_strlen($suffix) > 255)) {
            throw new \InvalidArgumentException('invalid length for $suffix when calling CreateMember., must be smaller than or equal to 255.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateMember., must be smaller than or equal to 255.');
        }
