...
class Product implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'folder_id' => 'int',
        'folder' => '\NathanEmanuel\Congressus\Rest\Model\ProductFolder',
        'name' => 'string',
        'description' => 'string',
    ...
    */
     ...
     * Sets folder_id
     *
     * @param int $folder_id id for the product folder
     *
     * @return self
     */
     ...
     * Gets folder
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null
     */
     ...
     * Sets folder
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\ProductFolder|null $folder folder
     *
     * @return self
     */
