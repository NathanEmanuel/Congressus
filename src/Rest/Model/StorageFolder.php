 ...
 */
class StorageFolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorageFolder';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StorageFolder., must be smaller than or equal to 255.');
        }
     ...
     * Sets slug
     *
     * @param string $slug Slug for this storage folder, used for navigation on the website
     *
     * @return self
     */
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 255)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling StorageFolder., must be smaller than or equal to 255.');
        }
     ...
     * Sets path
     *
     * @param string|null $path Path used on the website for storage objects in this folder, based on the slugs of this folder and parent folders
     *
     * @return self
     */
