...
class FormField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'string',
        'data_type' => 'string',
        'choices' => '\NathanEmanuel\Congressus\Rest\Model\FormFieldOption[]'
    ];
    ...
    */
     ...
     * Gets choices
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\FormFieldOption[]|null
     */
     ...
     * Sets choices
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\FormFieldOption[]|null $choices Available choices for this field. Only available for fields with type 'option' or 'option_multiple'.
     *
     * @return self
     */
