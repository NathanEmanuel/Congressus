<?php
/**
 * CareerPartnerCategoryPagination
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CareerPartnerCategoryPagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class CareerPartnerCategoryPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CareerPartnerCategoryPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\CareerPartnerCategory[]'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\CareerPartnerCategory[]|null $data data
     *
     * @return self
     */
