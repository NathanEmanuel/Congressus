...
class BankStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'bank_import' => '\NathanEmanuel\Congressus\Rest\Model\BankImport',
        'statement_id' => 'string',
        'iban' => 'string',
        'begin' => '\DateTime',
        'end' => '\DateTime'
    ...
    */
     ...
     * Gets bank_import
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\BankImport|null
     */
     ...
     * Sets bank_import
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BankImport|null $bank_import bank_import
     *
     * @return self
     */
