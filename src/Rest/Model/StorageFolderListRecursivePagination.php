<?php
/**
 * StorageFolderListRecursivePagination
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * StorageFolderListRecursivePagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class StorageFolderListRecursivePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorageFolderListRecursivePagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\StorageFolder[]'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\StorageFolder[]|null $data data
     *
     * @return self
     */
