...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'category_id' => 'int',
        'category' => '\NathanEmanuel\Congressus\Rest\Model\EventCategoryBase',
        'status' => 'string',
        'slug' => 'string',
        'name' => 'string',
        'description' => 'string',
        ...
        'location' => 'string',
        'organizer_id' => 'int',
        'organizer' => '\NathanEmanuel\Congressus\Rest\Model\Group',
        ...
        'ticket_types' => '\NathanEmanuel\Congressus\Rest\Model\EventTicketType[]',
        'num_tickets' => 'int',
        ...
        'rental_enabled' => 'bool',
        'rental_categories' => '\NathanEmanuel\Congressus\Rest\Model\RentalCategory[]',
        'rental_max_price' => 'float',
        'career_partners' => '\NathanEmanuel\Congressus\Rest\Model\CareerPartner1[]',
        'website_url' => 'string',
        'website_subscribe_url' => 'string',
        'comments_open' => 'bool',
        'comments' => '\NathanEmanuel\Congressus\Rest\Model\EventComment[]',
        'media' => '\NathanEmanuel\Congressus\Rest\Model\StorageObject[]',
        'memo' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('organizer_id', $data ?? [], null);
        ...
        $this->setIfExists('participation_mode', $data ?? [], 'single');
        ...
        $this->setIfExists('num_tickets_max_per_order', $data ?? [], 1);
    ...
    */
     ...
     * Gets category
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\EventCategoryBase|null
     */
     ...
     * Sets category
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\EventCategoryBase|null $category category
     *
     * @return self
     */
    ...
    {
        return $this->container['organizer_id'];
    }

    /**
     * Sets organizer_id
     *
     * @param int|null $organizer_id organizer_id
     *
     * @return self
     */
    public function setOrganizerId($organizer_id)
    {
        if (is_null($organizer_id)) {
            throw new \InvalidArgumentException('non-nullable organizer_id cannot be null');
        }
        $this->container['organizer_id'] = $organizer_id;
     ...
     * Sets organizer
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\Group|null $organizer organizer
     *
     * @return self
     */
    ...
    public function setShowParticipants($show_participants)
    {
        if (is_null($show_participants)) {
            throw new \InvalidArgumentException('non-nullable show_participants cannot be null');
        }
    ...
    public function setShowWaitingList($show_waiting_list)
    {
        if (is_null($show_waiting_list)) {
            throw new \InvalidArgumentException('non-nullable show_waiting_list cannot be null');
        }
    ...
    public function setShowRentedItems($show_rented_items)
    {
        if (is_null($show_rented_items)) {
            throw new \InvalidArgumentException('non-nullable show_rented_items cannot be null');
        }
     ...
     *
     * @param string|null $participation_information_collection_type Define if name and email is required per order or per ticket.
     *
     * @return self
     */
     ...
     * Gets ticket_types
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\EventTicketType[]|null
     */
     ...
     * Sets ticket_types
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\EventTicketType[]|null $ticket_types ticket_types
     *
     * @return self
     */
     ...
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\RentalCategory[]|null
     */
     ...
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\RentalCategory[]|null $rental_categories Rental categories from which participants can rent items
     *
     * @return self
     */
     ...
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\CareerPartner1[]|null
     */
     ...
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\CareerPartner1[]|null $career_partners career_partners
     *
     * @return self
     */
     ...
     * Gets comments
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\EventComment[]|null
     */
     ...
     * Sets comments
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\EventComment[]|null $comments comments
     *
     * @return self
     */
     ...
     * Sets media
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\StorageObject[]|null $media media
     *
     * @return self
     */
