...
/**
 * CareerPartnerPagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class CareerPartnerPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CareerPartnerPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\CareerPartner[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\CareerPartner[]|null
     */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\CareerPartner[]|null $data data
     *
     * @return self
     */
