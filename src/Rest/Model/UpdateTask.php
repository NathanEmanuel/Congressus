 ...
 */
class UpdateTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $type when calling UpdateTask., must be smaller than or equal to 255.');
        }
    ...
    public function setSubjectType($subject_type)
    {
        ...
        if ((mb_strlen($subject_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject_type when calling UpdateTask., must be smaller than or equal to 255.');
        }
