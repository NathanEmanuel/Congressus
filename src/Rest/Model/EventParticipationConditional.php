...
/**
 * EventParticipationConditional Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class EventParticipationConditional implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventParticipationConditional';
    ...
    protected static $setters = [
        'check_conditions' => 'setCheckConditions'
    ];
    ...
    protected static $getters = [
        'check_conditions' => 'getCheckConditions'
    ];
    ...
    {
        $this->setIfExists('check_conditions', $data ?? [], true);
    }
    ...
    */
    ...
    /**
     * Gets check_conditions
     *
     * @return bool|null
     */
    public function getCheckConditions()
    {
        return $this->container['check_conditions'];
    }

    /**
     * Sets check_conditions
     *
     * @param bool|null $check_conditions Check conditions for this transition. When set to False, the transition is always performed.
     *
     * @return self
     */
    public function setCheckConditions($check_conditions)
    {
        if (is_null($check_conditions)) {
            throw new \InvalidArgumentException('non-nullable check_conditions cannot be null');
        }
        $this->container['check_conditions'] = $check_conditions;
