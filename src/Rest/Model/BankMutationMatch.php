...
/**
 * BankMutationMatch Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class BankMutationMatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankMutationMatch';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'type' => 'string',
        'payment' => '\NathanEmanuel\Congressus\Rest\Model\SaleInvoicePayment',
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if (!is_null($type) && (mb_strlen($type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BankMutationMatch., must be smaller than or equal to 50.');
        }
     ...
     * Sets payment
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\SaleInvoicePayment|null $payment payment
     *
     * @return self
     */
