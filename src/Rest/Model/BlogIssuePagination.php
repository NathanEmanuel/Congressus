...
/**
 * BlogIssuePagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class BlogIssuePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlogIssuePagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\BlogIssue[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\BlogIssue[]|null
     */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BlogIssue[]|null $data data
     *
     * @return self
     */
