...
class Form implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'mail_user' => 'bool',
        'mail_organisation' => 'bool',
        'mail_organisation_address' => 'string',
        'published' => 'bool',
        'num_entries' => 'int',
        'num_entries_open' => 'int',
        'created' => '\DateTime',
        'modified' => '\DateTime',
        'sets' => '\NathanEmanuel\Congressus\Rest\Model\FormSet[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'title' => null,
        'mail_user' => null,
        'mail_organisation' => null,
        'mail_organisation_address' => null,
        'published' => null,
        'num_entries' => null,
        'num_entries_open' => null,
        'created' => 'date-time',
        'modified' => 'date-time',
        'sets' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'title' => false,
        'mail_user' => false,
        'mail_organisation' => false,
        'mail_organisation_address' => false,
        'published' => false,
        'num_entries' => false,
        'num_entries_open' => false,
        'created' => false,
        'modified' => false,
        'sets' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'mail_organisation_address' => 'mail_organisation_address',
        'published' => 'published',
        'num_entries' => 'num_entries',
        'num_entries_open' => 'num_entries_open',
        'created' => 'created',
        'modified' => 'modified',
        'sets' => 'sets'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'title' => 'setTitle',
        'mail_user' => 'setMailUser',
        'mail_organisation' => 'setMailOrganisation',
        'mail_organisation_address' => 'setMailOrganisationAddress',
        'published' => 'setPublished',
        'num_entries' => 'setNumEntries',
        'num_entries_open' => 'setNumEntriesOpen',
        'created' => 'setCreated',
    ...
    protected static $getters = [
        'id' => 'getId',
        'title' => 'getTitle',
        'mail_user' => 'getMailUser',
        'mail_organisation' => 'getMailOrganisation',
        'mail_organisation_address' => 'getMailOrganisationAddress',
        'published' => 'getPublished',
        'num_entries' => 'getNumEntries',
        'num_entries_open' => 'getNumEntriesOpen',
        'created' => 'getCreated',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mail_user', $data ?? [], null);
        $this->setIfExists('mail_organisation', $data ?? [], null);
        $this->setIfExists('mail_organisation_address', $data ?? [], null);
        $this->setIfExists('published', $data ?? [], null);
        $this->setIfExists('num_entries', $data ?? [], null);
        $this->setIfExists('num_entries_open', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['mail_user'];
    }

    /**
     * Sets mail_user
     *
     * @param bool|null $mail_user Whether to send an email to the user after submitting the form.
     *
     * @return self
     */
    public function setMailUser($mail_user)
    {
        if (is_null($mail_user)) {
            throw new \InvalidArgumentException('non-nullable mail_user cannot be null');
        }
        $this->container['mail_user'] = $mail_user;

        return $this;
    }

    /**
     * Gets mail_organisation
     *
     * @return bool|null
     */
    public function getMailOrganisation()
    {
        return $this->container['mail_organisation'];
    }

    /**
     * Sets mail_organisation
     *
     * @param bool|null $mail_organisation Whether to send an email to the organisation after submitting the form.
     *
     * @return self
     */
    public function setMailOrganisation($mail_organisation)
    {
        if (is_null($mail_organisation)) {
            throw new \InvalidArgumentException('non-nullable mail_organisation cannot be null');
        }
        $this->container['mail_organisation'] = $mail_organisation;

        return $this;
    }

    /**
     * Gets mail_organisation_address
     *
     * @return string|null
     */
    public function getMailOrganisationAddress()
    {
        return $this->container['mail_organisation_address'];
    }

    /**
     * Sets mail_organisation_address
     *
     * @param string|null $mail_organisation_address Email address to send the organisation email to. Multiple addresses can be separated by commas.
     *
     * @return self
     */
    public function setMailOrganisationAddress($mail_organisation_address)
    {
        if (is_null($mail_organisation_address)) {
            throw new \InvalidArgumentException('non-nullable mail_organisation_address cannot be null');
        }
        $this->container['mail_organisation_address'] = $mail_organisation_address;
     ...
     * Sets published
     *
     * @param bool|null $published Whether the form is published and available for users.
     *
     * @return self
     */
     ...
     * Sets num_entries
     *
     * @param int|null $num_entries Number of entries for this form.
     *
     * @return self
     */
    public function setNumEntries($num_entries)
    {
        if (is_null($num_entries)) {
            throw new \InvalidArgumentException('non-nullable num_entries cannot be null');
        }
    ...
    /**
     * Gets num_entries_open
     *
     * @return int|null
     */
    public function getNumEntriesOpen()
    {
        return $this->container['num_entries_open'];
    }

    /**
     * Sets num_entries_open
     *
     * @param int|null $num_entries_open Number of current (i.e. not archived) entries for this form.
     *
     * @return self
     */
    public function setNumEntriesOpen($num_entries_open)
    {
        if (is_null($num_entries_open)) {
            throw new \InvalidArgumentException('non-nullable num_entries_open cannot be null');
        }
        $this->container['num_entries_open'] = $num_entries_open;
     ...
     * Gets sets
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\FormSet[]|null
     */
     ...
     * Sets sets
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\FormSet[]|null $sets List of fieldsets for this form.
     *
     * @return self
     */
