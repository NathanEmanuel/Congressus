...
class LogEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created' => '\DateTime',
        'modified' => '\DateTime',
        'author' => '\NathanEmanuel\Congressus\Rest\Model\LogEntryUser',
        'subject' => '\NathanEmanuel\Congressus\Rest\Model\LogEntrySubject',
        'assignee_type' => 'string',
        'assignee_id' => 'int',
        'assignee' => '\NathanEmanuel\Congressus\Rest\Model\LogEntryUser',
        'is_completed' => 'bool',
        'completed' => '\DateTime',
        'completed_by_id' => 'int',
        'completed_by' => '\NathanEmanuel\Congressus\Rest\Model\LogEntryUser',
        'action' => 'mixed',
        'changes' => 'mixed',
        'changes_pretty' => 'mixed'
    ];
    ...
    */
     ...
     * Gets author
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\LogEntryUser|null
     */
     ...
     * Sets author
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\LogEntryUser|null $author author
     *
     * @return self
     */
     ...
     * Gets subject
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\LogEntrySubject|null
     */
     ...
     * Sets subject
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\LogEntrySubject|null $subject subject
     *
     * @return self
     */
     ...
     * Sets assignee
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\LogEntryUser|null $assignee assignee
     *
     * @return self
     */
     ...
     * Sets completed_by
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\LogEntryUser|null $completed_by completed_by
     *
     * @return self
     */
     ...
     * Sets changes_pretty
     *
     * @param mixed|null $changes_pretty changes_pretty
     *
     * @return self
     */
    public function setChangesPretty($changes_pretty)
    {
        if (is_null($changes_pretty)) {
            array_push($this->openAPINullablesSetToNull, 'changes_pretty');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('changes_pretty', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
