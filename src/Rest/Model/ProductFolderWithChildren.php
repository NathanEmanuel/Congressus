...
/**
 * ProductFolderWithChildren Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class ProductFolderWithChildren implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductFolderWithChildren';
    ...
    protected static $openAPITypes = [
        ...
        'published' => 'bool',
        'path' => 'string',
        'children' => '\NathanEmanuel\Congressus\Rest\Model\ProductFolderWithChildren[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductFolderWithChildren., must be smaller than or equal to 255.');
        }
     ...
     * Sets slug
     *
     * @param string $slug Slug for this product folder, used for navigation on the website
     *
     * @return self
     */
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 255)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling ProductFolderWithChildren., must be smaller than or equal to 255.');
        }
     ...
     * Sets path
     *
     * @param string|null $path Path used on the website for products in this folder, based on the slugs of this folder and parent folders
     *
     * @return self
     */
     ...
     * Gets children
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\ProductFolderWithChildren[]|null
     */
     ...
     * Sets children
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\ProductFolderWithChildren[]|null $children children
     *
     * @return self
     */
