 ...
 */
class ContentRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentRow';
    ...
    protected static $openAPITypes = [
        'order' => 'int',
        'content_items' => '\NathanEmanuel\Congressus\Rest\Model\ContentItem[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('content_items', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets content_items
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\ContentItem[]|null
     */
    public function getContentItems()
    {
        return $this->container['content_items'];
    }

    /**
     * Sets content_items
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\ContentItem[]|null $content_items content_items
     *
     * @return self
     */
    public function setContentItems($content_items)
    {
        if (is_null($content_items)) {
            throw new \InvalidArgumentException('non-nullable content_items cannot be null');
        }
        $this->container['content_items'] = $content_items;
