 ...
 */
class MemberField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberField';
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'string',
        'data_type' => 'string',
        'choices' => '\NathanEmanuel\Congressus\Rest\Model\MemberFieldOption[]',
        'tab' => 'string',
        'tab_order' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('set_order', $data ?? [], null);
    ...
    */
     ...
     * Sets ref
     *
     * @param string $ref Internal reference of the field.
     *
     * @return self
     */
     ...
     * Sets set
     *
     * @param string|null $set Set title for the field.
     *
     * @return self
     */
    ...
    {
        return $this->container['set_order'];
    }

    /**
     * Sets set_order
     *
     * @param int|null $set_order set_order
     *
     * @return self
     */
    public function setSetOrder($set_order)
    {
        if (is_null($set_order)) {
            throw new \InvalidArgumentException('non-nullable set_order cannot be null');
        }
        $this->container['set_order'] = $set_order;
     ...
     * Sets data_type
     *
     * @param string|null $data_type Data type of the field.
     *
     * @return self
     */
     ...
     * Gets choices
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\MemberFieldOption[]|null
     */
     ...
     * Sets choices
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\MemberFieldOption[]|null $choices Available choices for this field. Only available for fields with type 'option' or 'option_multiple'.
     *
     * @return self
     */
     ...
     * Sets tab
     *
     * @param string|null $tab Tab title for the field.
     *
     * @return self
     */
     ...
     * Sets tab_order
     *
     * @param int|null $tab_order tab_order
     *
     * @return self
     */
