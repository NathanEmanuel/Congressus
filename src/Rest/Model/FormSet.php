 ...
 */
class FormSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormSet';
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'order' => 'int',
        'fields' => '\NathanEmanuel\Congressus\Rest\Model\FormField[]'
    ];
    ...
    */
     ...
     * Sets title
     *
     * @param string $title Title of the form set.
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int $order Order of the form set.
     *
     * @return self
     */
     ...
     * Gets fields
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\FormField[]|null
     */
     ...
     * Sets fields
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\FormField[]|null $fields List of fields for this form set. Contains information about each field, such as title, description, type, etc.
     *
     * @return self
     */
