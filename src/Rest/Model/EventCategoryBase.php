...
/**
 * EventCategoryBase Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class EventCategoryBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventCategoryBase';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EventCategoryBase., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EventCategoryBase., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (mb_strlen($color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $color when calling EventCategoryBase., must be smaller than or equal to 7.');
        }
        if (!is_null($color) && (!preg_match("/^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling EventCategoryBase., must conform to the pattern /^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/.");
        }
