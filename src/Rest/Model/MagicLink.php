...
class MagicLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CONTEXT_EVENT_SIGN_UP = 'event_sign_up';
    ...
    */
     ...
     * Sets member_id
     *
     * @param int $member_id ID of the member to create this magic link for.
     *
     * @return self
     */
     ...
     * Sets context
     *
     * @param string $context The context the magic link is for.
     *
     * @return self
     */
     ...
     * Sets max_age
     *
     * @param int|null $max_age The context the magic link is for. Optional, the context's default max age will be used if not set.
     *
     * @return self
     */
     ...
     * Sets website_id
     *
     * @param int|null $website_id ID of the website to create this magic link for.
     *
     * @return self
     */
     ...
     * Sets redirect_url
     *
     * @param string|null $redirect_url Redirect URL for the magic link. The user will be redirected to this URL after logging in with the magic link. Can be a relative or absolute URL. Optional.
     *
     * @return self
     */
