...
/**
 * OrganisationWithCustomFields Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class OrganisationWithCustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganisationWithCustomFields';
    ...
    protected static $openAPITypes = [
        ...
        'published' => 'bool',
        'category_id' => 'int',
        'category' => '\NathanEmanuel\Congressus\Rest\Model\OrganisationCategory',
        'address' => '\NathanEmanuel\Congressus\Rest\Model\Address',
        'postal_address' => '\NathanEmanuel\Congressus\Rest\Model\Address',
        'phone' => '\NathanEmanuel\Congressus\Rest\Model\PhoneNumber',
        'description' => 'string',
        'description_short' => 'string',
        'email' => 'string',
        'url' => 'string',
        'logo' => '\NathanEmanuel\Congressus\Rest\Model\StorageObject',
        'memo' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OrganisationWithCustomFields., must be smaller than or equal to 255.');
        }
     ...
     * Gets category
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\OrganisationCategory|null
     */
     ...
     * Sets category
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\OrganisationCategory|null $category category
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\Address|null
     */
     ...
     * Sets address
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\Address|null $address address
     *
     * @return self
     */
     ...
     * Sets postal_address
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\Address|null $postal_address postal_address
     *
     * @return self
     */
     ...
     * Gets phone
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\PhoneNumber|null
     */
     ...
     * Sets phone
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\PhoneNumber|null $phone phone
     *
     * @return self
     */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling OrganisationWithCustomFields., must be smaller than or equal to 255.');
        }
     ...
     * Gets logo
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\StorageObject|null
     */
     ...
     * Sets logo
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\StorageObject|null $logo logo
     *
     * @return self
     */
    ...
    public function setInvoiceReference($invoice_reference)
    {
        ...
        if ((mb_strlen($invoice_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_reference when calling OrganisationWithCustomFields., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceAddresseeAttention($invoice_addressee_attention)
    {
        ...
        if ((mb_strlen($invoice_addressee_attention) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_addressee_attention when calling OrganisationWithCustomFields., must be smaller than or equal to 255.');
        }
    ...
    public function setInvoiceEmail($invoice_email)
    {
        ...
        if ((mb_strlen($invoice_email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_email when calling OrganisationWithCustomFields., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param object|null $custom_field_data Object with custom field information for this organisation. Contains key/value pairs, with key being the field reference and value the field value.
     *
     * @return self
     */
