...
/**
 * BlogWithParagraph Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class BlogWithParagraph implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlogWithParagraph';
    ...
    protected static $openAPITypes = [
        ...
        'memo' => 'string',
        'paragraphs' => '\NathanEmanuel\Congressus\Rest\Model\BlogParagraph[]'
    ];
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling BlogWithParagraph., must be smaller than or equal to 255.');
        }
     ...
     * Sets issue_id
     *
     * @param int|null $issue_id issue_id
     *
     * @return self
     */
     ...
     * Sets published
     *
     * @param bool|null $published True when this blog is published on the website
     *
     * @return self
     */
     ...
     * Sets published_from
     *
     * @param \DateTime|null $published_from published_from
     *
     * @return self
     */
    public function setPublishedFrom($published_from)
    {
        if (is_null($published_from)) {
            array_push($this->openAPINullablesSetToNull, 'published_from');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('published_from', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets visibility
     *
     * @param string|null $visibility Visibility level set for this blog
     *
     * @return self
     */
     ...
     *
     * @param bool|null $authentication_required True when only authenticated users are allowed to view this blog
     *
     * @return self
     */
     ...
     * Sets memo
     *
     * @param string|null $memo Internal notes for this blog
     *
     * @return self
     */
     ...
     * Gets paragraphs
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\BlogParagraph[]|null
     */
     ...
     * Sets paragraphs
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BlogParagraph[]|null $paragraphs paragraphs
     *
     * @return self
     */
