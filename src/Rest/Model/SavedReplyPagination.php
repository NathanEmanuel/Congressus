...
/**
 * SavedReplyPagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class SavedReplyPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SavedReplyPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\SavedReply[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\SavedReply[]|null
     */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\SavedReply[]|null $data data
     *
     * @return self
     */
