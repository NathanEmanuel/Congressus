 ...
 */
class FormEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormEntry';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'form' => '\NathanEmanuel\Congressus\Rest\Model\BaseForm',
        'user_id' => 'int',
        'data' => 'object',
        'ip' => 'string',
    ...
    */
     ...
     * Gets form
     *
     * @return \NathanEmanuel\Congressus\Rest\Model\BaseForm|null
     */
     ...
     * Sets form
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\BaseForm|null $form form
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object|null $data Object with field information for this entry. Contains key/value pairs, with key being the field reference and value the field value.
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string|null $ip IP address through which this entry is added
     *
     * @return self
     */
     ...
     * Sets archived_at
     *
     * @param \DateTime|null $archived_at Datetime at which this entry was archived
     *
     * @return self
     */
     ...
     * Sets is_archived
     *
     * @param bool|null $is_archived Whether this entry is archived
     *
     * @return self
     */
