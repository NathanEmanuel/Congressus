...
/**
 * GroupFolderPagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class GroupFolderPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupFolderPagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\GroupFolder[]'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\GroupFolder[]|null $data data
     *
     * @return self
     */
