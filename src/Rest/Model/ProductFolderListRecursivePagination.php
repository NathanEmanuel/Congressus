...
/**
 * ProductFolderListRecursivePagination Class Doc Comment
 *
 * @category Class
 * @package  NathanEmanuel\Congressus\Rest
 * @author   OpenAPI Generator team
 ...
 */
class ProductFolderListRecursivePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductFolderListRecursivePagination';
    ...
    protected static $openAPITypes = [
        ...
        'has_next' => 'bool',
        'next_num' => 'int',
        'data' => '\NathanEmanuel\Congressus\Rest\Model\ProductFolderWithChildren[]'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \NathanEmanuel\Congressus\Rest\Model\ProductFolderWithChildren[]|null $data data
     *
     * @return self
     */
